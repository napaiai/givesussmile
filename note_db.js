...
'<span>데이터베이스</span>',
'<span>데이터베이스 트랜잭션</span>',
'<span>데이터 무결성</span>',
'<span>데이터베이스 모델링</span>',
'<span>ACID</span>',
'<span>Isolation Level</span>',
'<span>데이터 독립성</span>',
'<span>[데이터 독립성]- ANSI SPARC 3계층</span>',
'<span>병행제어 = 동시성제어</span>',
'<span>[동시성제어]- 트랜잭션 직렬화</span>',
'<span>[동시성제어]- Timestamp</span>',
'<span>[동시성제어]- Locking</span>',
'<span>[동시성제어]- 2PL</span>',
'<span>[동시성제어]- Phantom Conflict</span>',
'<span>[동시성제어]- MVCC</span>',
'<span>[동시성제어]- 낙관적 검증</span>',
'<span>회복기법</span>',
'<span>[회복기법]- Log 기반</span>',
'<span>[회복기법]- 그림자 페이지</span>',
'<span>[회복기법]- 체크포인트</span>',
'<span>[회복기법]- 미디어</span>',
'<span>[회복기법]- WAL정책</span>',
'<span>[회복기법][WAL]- ARIES</span>',
'<span>[일관성]- SAGA</span>',
'<span>[일관성][SAGA]- Choreography-Based Saga</span>',
'<span>[일관성][SAGA]- Orchestration-Based Saga</span>',
'<span>DB 이상현상</span>',
'<span>정규화</span>',
'<span>역정규화</span>',
'<span>[정규화]-암스트롱 공리, 함수폐포, 자기참조관계</span>',
'<span>관계대수</span>',
'<span>관계해석</span>',
'<span>이벤트 소싱(Event Sourcing)</span>',
'<span>다차원 모델링</span>',
'<span>[다차원 모델링]- 스타 스키마</span>',
'<span>[SNA]- 중심성(Centrality)</span>',
'<span>CKAN(Comprehensive Knowledge Archive Network)</span>',
'<span>[DB Stakeholder]- DA</span>',
'<span>[DB Stakeholder]- DBA</span>',
'<span>[DB Stakeholder]- Data Scientist</span>',
'<span>DQM</span>',
'<span>DQM3</span>',
'<span>ISO 11179</span>',
'<span>TTAK.KO-10.0555</span>',
'<span>ISO/IEC 20943-5</span>',
'<span>DQC</span>',
'<span>인덱스</span>',
'<span>다차원 색인구조</span>',
'<span>[다차원 색인]- PAM</span>',
'<span>[다차원 색인]- SAM</span>',
'<span>[다차원 색인]- 인덱스 구조(B,R,T-Tree)</span>',
'<span>[다차원 색인]- Hilbert R-Tree</span>',
'<span>Hashing</span>',
'<span>Clustering Factor</span>',
'<span>NewSQL DBMS</span>',
'<span>데이터 리터러시(Data Literacy)</span>',
'<span>Join</span>',
'<span>Hint</span>',
'<span>데이터 표준화</span>',
'<span>데이터 표준 관리도구</span>',
'<span>DB Tunning</span>',
'<span>[DBMS 최적화]- Optimizer</span>',
'<span>[DBMS 최적화]- Data Block Access</span>',
'<span>[DBMS 최적화]- Parallel Operation</span>',
'<span>Database View</span>',
'<span>ERD</span>',
'<span>관계형 데이터 모델</span>',
'<span>연결함정</span>',
'<span>[빅데이터]- Edge Analytics</span>',
'<span>[빅데이터]- R-HIVE</span>',
'<span>[빅데이터]- NoSQL</span>',
'<span>[NoSQL]- Column Family Store</span>',
'<span>[NoSQL]- Graph Database</span>',
'<span>[빅데이터][NoSQL]- 데이터 모델링 패턴</span>',
'<span>[빅데이터][NoSQL]- CAP 이론</span>',
'<span>[빅데이터][NoSQL]- PACELC</span>',
'<span>[빅데이터][NoSQL]- NoSQL RDBMS 비교</span>',
'<span>[빅데이터][NoSQL]- BASE</span>',
'<span>[NoSQL]- Spatial DB</span>',
'<span>[빅데이터]- 빅데이터 개인정보보호 가이드라인</span>',
'<span>[빅데이터]- Hadoop</span>',
'<span>[빅데이터]- HDFS</span>',
'<span>[빅데이터]- Hadoop EcoSystem</span>',
'<span>[빅데이터]- ISO 20547</span>',
'<span>[빅데이터]- BigData 분석 방법론</span>',
'<span>[빅데이터]- DCAT</span>',
'<span>[빅데이터]- 데이터 플래그십</span>',
'<span>[빅데이터]- 단순 대치법</span>',
'<span>[빅데이터]- 결측값</span>',
'<span>[빅데이터]- 이상값</span>',
'<span>[빅데이터]- 정보 시각화</span>',
'<span>[빅데이터]- D-Commerce</span>',
'<span>[빅데이터]- Random Sampling</span>',
'<span>[빅데이터]- Filtering</span>',
'<span>DB 확장성 확보 방안</span>',
'<span>[DB확장]- Database Shard</span>',
'<span>[DB확장]- Database Partitioning</span>',
'<span>DB 복제 - Web Service</span>',
'<span>Data File Structure</span>',
'<span>인공지능 학습용 데이터 품질관리 지표</span>',
'<span>[통계]- 통계 관련 데이터</span>',
'<span>[통계]- 통계 Overview</span>',
'<span>[통계]- 데이터 분석 전처리</span>',
'<span>[통계][전처리]- 기술통계</span>',
'<span>[통계][전처리]- 추론통계</span>',
'<span>[통계]- 표본 추출 방법</span>',
'<span>[통계]- 특이정보, Outlier</span>',
'<span>[통계]- 재현정보</span>',
'<span>[통계]- 차등정보보호</span>',
'<span>[통계]- 분석기법</span>',
'<span>[통계][분석기법]- 회귀 분석</span>',
'<span>[통계][회귀 분석]- 다변량 회귀 분석</span>',
'<span>[통계][회귀 분석]- 선형회귀모형 추론 가정</span>',
'<span>[통계][분석기법]- 상관 분석</span>',
'<span>[통계][분석기법]- 주성분 분석</span>',
'<span>[통계][분석기법]- 다차원 척도법</span>',
'<span>[통계][분석기법]- 군집분석</span>',
'<span>[통계][분석기법][군집분석]- 계층적 군집분석</span>',
'<span>[통계][분석기법][군집분석]- 비계층적 군집분석</span>',
'<span>[통계][분석기법]- 판별 분석</span>',
'<span>[통계][분석기법]- 연관규칙</span>',
'<span>[통계][분석기법][연관규칙]- Apriori Algorithm</span>',
'<span>[통계]- 타당도</span>',
'<span>[통계]- 신뢰도</span>',
'<span>[통계]- CLT</span>',
'<span>[통계]- 추정이론(estimation theory)</span>',
'<span>[통계]- 가설검정 (Statistical Hypothesis Testing)</span>',
'<span>[통계]- 베이즈 정리</span>',
'<span>Data Mining</span>',
'<span>[Data Mining]- Text Mining</span>',
'<span>[Data Mining][Text]- 로봇 저널리즘</span>',
'<span>[Data Mining]- 단어구름(Word Cloud)</span>',
'<span>[Data Mining]- Co-Word Analysis</span>',
'<span>[Data Mining]- 데이터 분석 기술</span>',
'<span>[Data Mining]- 토픽 모델링</span>',
'<span>[Data Mining]- Opinion Mining</span>',
'<span>[Data Mining]- System Dynamics</span>',
'<span>[Data Mining]- CRISP-DM</span>',
'<span>데이터 사이언스</span>',
'<span>반정형 데이터</span>',
'<span>RAID</span>',
'<span>DMBOK</span>',
