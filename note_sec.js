...
'<re>[개론]- 보안 아키텍처</re>',
'<re>[개론]- 보안 Overview</re>',
'<re>[개론]- 보안이슈, 대응방안</re>',
'<re>[개론]- 내외부 정보보안 위협</re>',
'<re>[개론]- 공격 유형 Overview</re>',
'<re>[개론]- 보안 약점, 취약점</re>',
'<re>[개론]- STRIDE</re>',
'<re>암호학</re>',
'<re>[암호학]- Kerckhoff 원리</re>',
'<re>[암호학]- 혼돈과 확산</re>',
'<re>[암호학]- 암호문 분석(공격모델)</re>',
'<re>[암호학]- 알고리즘 보안강도</re>',
'<re>[암호학]- 블록암호화</re>',
'<re>[블록암호화]- Feistel Cipher</re>',
'<re>[블록암호화]- SPN Cipher</re>',
'<re>[블록암호화]- 블록암호화 운영모드</re>',
'<re>[블록암호화 운영모드]- ECB</re>',
'<re>[블록암호화 운영모드]- CBC</re>',
'<re>[블록암호화 운영모드]- PCBC</re>',
'<re>[블록암호화 운영모드]- CFB</re>',
'<re>[블록암호화 운영모드]- OFB</re>',
'<re>[블록암호화 운영모드]- CTR</re>',
'<re>[암호학][스트림]- OTP</re>',
'<re>[암호학]- PKI</re>',
'<re>[암호학][PKI]- X.509</re>',
'<re>[암호학][PKI]- 2020 정부 전자서명법 개정</re>',
'<re>[암호학]- 전자서명,전자봉투</re>',
'<re>[암호학][전자서명,봉투]- 이중서명</re>',
'<re>[암호학]- 양자암호통신</re>',
'<re>[암호학][양자 보안]- QKD</re>',
'<re>[암호학][양자 보안]- PQC</re>',
'<re>[암호학]- 검색가능암호화</re>',
'<re>[암호학][검색가능암호화]- PSES</re>',
'<re>[암호학]- Base64</re>',
'<re>[암호학][비대칭 암호]- 디피헬만 알고리즘</re>',
'<re>[암호학][비대칭 암호]- ECC</re>',
'<re>[암호학][비대칭 암호][ECC]- ECDSA</re>',
'<re>[암호학][단방향 암호]- Hash Function</re>',
'<re>[암호학][단방향 암호][Hash Function]- Hash Algorithm</re>',
'<re>[암호학][Hash Algorithm]- MDC</re>',
'<re>[암호학][Hash Algorithm]- MAC</re>',
'<re>[암호학][Hash Algorithm]- Hash Salt</re>',
'<re>[암호학][Hash Algorithm]- Key Stretching</re>',
'<re>[암호학]경량 암호</re>',
'<re>[암호학][경량 암호]- LSH 암호화</re>',
'<re>[암호학][경량 암호]- LEA 암호화</re>',
'<re>[암호학]형태 보존 암호화</re>',
'<re>[암호학]순서 보존 암호화</re>',
'<re>[암호학]- 동형암호</re>',
'<re>[암호학][동형암호]- 준 동형암호</re>',
'<re>[암호학][동형암호]- 완전 동형암호</re>',
'<re>접근통제</re>',
'<re>[접근통제][정책]- MAC</re>',
'<re>[접근통제][정책]- DAC</re>',
'<re>[접근통제][정책]- RBAC</re>',
'<re>[접근통제][모델]- Bell LaPadula</re>',
'<re>[접근통제][모델]- Biba</re>',
'<re>[접근통제][모델]- Clark-Wilson</re>',
'<re>[접근통제][네트워크]- TCP Wrapper</re>',
'<re>[보안 솔루션]- 방화벽</re>',
'<re>[보안 솔루션][방화벽]- 웹 방화벽</re>',
'<re>[보안 솔루션][방화벽]- 차세대 방화벽</re>',
'<re>[보안 솔루션]- Iptables</re>',
'<re>[보안 솔루션]- IDS</re>',
'<re>[보안 솔루션]- DPI</re>',
'<re>[보안 솔루션][DPI]- IPS</re>',
'<re>[보안 솔루션][DPI]- WIPS</re>',
'<re>[보안 솔루션][기업보안]- UTM</re>',
'<re>[보안 솔루션][기업보안]- ESM</re>',
'<re>[보안 솔루션][기업보안]- RMS</re>',
'<re>[보안 솔루션][기업보안]- SIEM</re>',
'<re>[보안 솔루션][DB보안]- DB 암호화</re>',
'<re>[보안 솔루션][DB보안]- DLP</re>',
'<re>[보안 솔루션][File보안]- DRM</re>',
'<re>[보안 솔루션][기업보안]- EMM</re>',
'<re>[보안 솔루션][기업보안]- NAC</re>',
'<re>[보안 솔루션][NAC]- WNAC</re>',
'<re>[보안 솔루션][Key보안]- HSM</re>',
'<re>[보안 솔루션]- AAA</re>',
'<re>[보안 솔루션][AAA]- RADIOUS</re>',
'<re>[보안 솔루션][AAA]- DIAMETER</re>',
'<re>[보안 솔루션][DIAMETER]- Kerberos</re>',
'<re>[보안 솔루션][Kerberos]- SSO</re>',
'<re>[보안 솔루션][SSO]- EAM</re>',
'<re>[보안 솔루션][SSO]- IAM</re>',
'<re>[보안 솔루션]- FIDO</re>',
'<re>[보안 솔루션][FIDO]- UAF 기술 표준</re>',
'<re>[해킹]- 해킹, 악성프로그램</re>',
'<re>[해킹]- 랜섬웨어</re>',
'<re>[해킹][랜섬웨어]- RaaS</re>',
'<re>[해킹][랜섬웨어]- 표적형 랜섬웨어</re>',
'<re>[해킹][랜섬웨어]- DBD</re>',
'<re>[해킹][랜섬웨어]- 드라이브 바이 크립토마이닝(drive-by cryptomining)</re>',
'<re>[해킹][랜섬웨어]- 로키 랜섬웨어(Locky Ransomware)</re>',
'<re>[해킹][랜섬웨어]- 워너크립터</re>',
'<re>[해킹][랜섬웨어]- 독스웨어(doxware)</re>',
'<re>[해킹][랜섬웨어]- 배드래빗(Bad Rabbit)</re>',
'<re>[해킹][랜섬웨어]- 사이버범죄 서비스(CaaS, Cybercrime as a Service)</re>',
'<re>[해킹][랜섬웨어]- 갠드크랩(GandCrab) 랜섬웨어</re>',
'<re>[해킹]- APT</re>',
'<re>[해킹][APT]- Lateral Movement</re>',
'<re>[해킹][APT][Lateral Movement]- IoA</re>',
'<re>[해킹][APT][Lateral Movement]- IoC</re>',
'<re>[해킹]- 산업제어시스템 보안</re>',
'<re>[해킹][APT]- 스턱스넷(stuxnet)</re>',
'<re>[해킹]- 비즈니스 스캠</re>',
'<re>[해킹][개론]- Cyber Kill Chain</re>',
'<re>[해킹][개론]- ATT and CK</re>',
'<re>[해킹]- 피싱(Phishing)</re>',
'<re>[해킹][피싱(Phshing)]- 액티브 피싱</re>',
'<re>[해킹][피싱(Phshing)]- 스피어 피싱</re>',
'<re>[해킹]- 파밍(Pharming)</re>',
'<re>[해킹]- 스미싱(Smishing)</re>',
'<re>[해킹]- 스니핑(Sniffing)</re>',
'<re>[해킹]- 스푸핑(Spoofing)</re>',
'<re>[해킹]- Session Hijacking</re>',
'<re>[해킹]- 워터링 홀 공격(Watering Hole Attack)</re>',
'<re>[해킹]- 루트킷(Rootkit)</re>',
'<re>[해킹]- 포맷 스트링 공격</re>',
'<re>[해킹]- 카멜레온 바이러스</re>',
'<re>[해킹]- 스테이지 프라이트(Stage Fright)</re>',
'<re>[해킹]- 널 포인터 디레퍼런스(Null Pointer Dereference)</re>',
...
'<re>[해킹]- OWASP IoT Top 10</re>',
'<re>[해킹]- XSS</re>',
'<re>[해킹][XSS]- SSRF</re>',
'<re>[해킹][XSS]- CSRF</re>',
'<re>[해킹]- DDoS</re>',
'<re>[해킹][DDoS]- 스크러빙 센터, CDN</re>',
'<re>[해킹][DDoS]- TCP Traffic Flooding</re>',
'<re>[해킹][DDoS]- HTTP Head/Option Spoofing Flooding</re>',
'<re>[해킹][DDoS]- HashDoS</re>',
'<re>[해킹]- DRDoS</re>',
'<re>[해킹]- DNS 보안</re>',
'<re>[해킹]- 허니팟</re>',
'<re>[해킹]- 사이버 디셉션</re>',
...
'<re>[법률]- 데이터 3법</re>',
'<re>[법률][개인정보]- 정보유형</re>',
'<re>[법률][개인정보]- 개인정보 비식별 조치 가이드라인</re>',
'<re>[법률][개인정보]- 프라이버시 보호모델</re>',
'<re>[법률][개인정보]- 개인정보의 안전성 확보조치 기준</re>',
'<re>[법률][개인정보]- 가명정보</re>',
'<re>[법률][개인정보][가명정보]- 결합전문기관</re>',
'<re>[법률][개인정보]- 가명처리 (ISO/IEC 20889 기준)</re>',
'<re>[법률][개인정보]- 비식별수준 적정성평가</re>',
'<re>[법률][개인정보][ISO/IEC 20889]- 재식별 공격</re>',
'<re>[법률][개인정보]- 식별자</re>',
'<re>[법률][개인정보]- 식별자, 민감정보</re>',
'<re>[법률]- ISMS</re>',
'<re>[법률][ISMS]- ISMS-P</re>',
'<re>[법률]- 개인정보 영향평가(PIA)</re>',
'<re>[법률][PIA]- ISO/IEC 29134</re>',
'<re>[법률]- ISO/IEC 27017</re>',
'<re>[법률]- ISO 27001</re>',
'<re>[법률]- ISO/IEC 27018</re>',
'<re>[법률]- GDPR</re>',
'<re>[법률][GDPR]- GDPR 적정성 평가</re>',
'<re>[보안활동]- ISO/IEC 27014</re>',
'<re>[보안활동]- IoT 공통 보안 7원칙</re>',
'<re>[보안활동]- 컴퓨터 포렌식(Computer forensics) = 디지털 포렌식</re>',
'<re>[보안활동][포렌식]- 클라우드 포렌식</re>',
'<re>[보안활동][포렌식]- 분산 포렌식 인덱싱</re>',
'<re>[보안활동][포렌식]- File Carving</re>',
'<re>[보안활동][포렌식]- e-Discovery</re>',
'<re>[보안활동]- CPO</re>',
'<re>[보안활동]- CISO</re>',
'<re>[보안활동]- CVE</re>',
'<re>[보안활동]- CWE</re>',
'<re>[보안활동]- 버그 바운티</re>',
'<re>[보안활동]- ISO/IEC 15408 (CC 인증)</re>',
'<re>[융합보안]- TEE</re>',
'<re>[융합보안]- Secure Boot</re>',
'<re>[융합보안][Cloud 보안]- SECaaS</re>',
'<re>[융합보안][Cloud 보안]- CWPP</re>',
'<re>[융합보안][Cloud 보안]- CSPM</re>',
'<re>[융합보안][Cloud 보안]- CASB</re>',
'<re>[공격기법]- Race Condition</re>',
'<re>Secure Coding</re>',
'<re>[Secure Coding]- TouchPoints 기법</re>',
'<re>[Secure Coding]- TOCTOU</re>',
'<re>크라임웨어(Crimeware)</re>',
'<re>멀버타이징(Mulvertising)</re>',
'<re>소프트웨어 개발보안 가이드</re>',
'<re>클라우드 컴퓨팅 보안</re>',
'<re>PETs</re>',
'<re>PPDM</re>',
'<re>ISO 29151</re>',
'<re>가상자산 사업자</re>',
'<re>가상자산 사업자 ISMS</re>',
'<re>[개인정보]- HIPPA Privacy Rule</re>',
'<re>[개인정보]- OECD Privacy 8원칙</re>',
'<re>[정보처리자유형]- 개인정보 유출사고 대응 매뉴얼</re>',
'<re>정보보호산업진흥법(15.12 시행)</re>',
'<re>정보윤리</re>',
'<re>[정보윤리]- 사이버 범죄</re>',
'<re>[정보윤리]- 사이버 중독</re>',
'<re>탈린 매뉴얼(Tallinn Manual)</re>',
'<re>ISA/IEC 62443</re>',
'<re>DarkSide Ransomware</re>',
'<re>코드서명 (코드사인, Codesign)</re>',
'<re>WPA3</re>',
'<re>라이트 커맨드(Light Commands) 취약점</re>',
'<re>무자각 지속 인증(Implicity Continuous Authentication)</re>',
'<re>개발보안 방법론</re>',
'<re>Privacy By Design</re>',
'<re>SDP</re>',
'<re>BEC(Business  E-mail Compromise)</re>',
'<re>[CPU 보안]- 스펙터(Spectre)</re>',
'<re>[CPU 보안]- Meltdown</re>',
'<re>[시스템 보안]- Shell Code</re>',
'<re>[시스템 보안]- Buffer Overflow</re>',
'<re>[시스템 보안]- Format String</re>',
'<re>[Android]- Deeplink</re>',
'<re>Zero Trust 보안 모델</re>',
'<re>재택,원격근무 정보보호 6대 실전 수칙</re>',
'<re>CDR</re>',
'<re>사이버 레질리언스</re>',
'<re>Reverse Turing Test</re>',
'<re>Turing Completeness</re>',
'<re>하인리히 법칙</re>',
'<re>SOAR</re>',
'<re>EMP</re>',
'<gr>[보안정책/관리]-[DDoS 대응]-Ddos 사이버 대피소</gr>',
'<gr>[보안기술]-[클라우드 컴퓨팅 보안]-CSAP</gr>',
);
...
//[보안정책/관리]-[DDoS 대응]-Ddos 사이버 대피소
'# 정의 : <re>피해 웹사이트로 향하는 DDoS 트래픽을 대피소로 우회</re>하여 분석,<br/>\
  차단함으로써 정상적으로 운영될 수 있도록 하는 <re>중소기업 무료지원 서비스</re><br/><br/>\
* 서비스 <bl>대상</bl> : <bl>“중소기업기본법 제2조”</bl> 및 <bl>“중소기업기본법 시행령 제3조”</bl>에<br/>\
  해당하는 중소기업<br/><br/>\
* 서비스 <bl>기간</bl> : 방어 서비스 <bl>적용 후 1개월</bl>을 기본으로 하며, <bl>재공격이 예상</bl>되는<br/>\
  경우 지속적으로 <bl>1개월 연장</bl><br/><br/>\
* 서비스 <gr>신청</gr> : <gr>사전등록 신청서</gr>, <gr>사업자등록증 작성</gr> 후 신청<br/><br/>\
',

//[보안기술]-[클라우드 컴퓨팅 보안]-CSAP
'<re>C</re>loud <re>S</re>ervice <re>A</re>ssurance <re>P</re>rogram, 클라우드 보안 인증제<br/><br/>\
* 정의 : <re>클라우드 서비스 제공자가 제공하는 서비스에 대해</re> \
『 클라우드 컴퓨팅 발전 및 이용자 보호에 관한 법률 』 제 23조 제2항에 따라 정보보호 기준의 준수여부 확인을 <re>인증기관이 평가·인증하여</re> 이용자들이 안심하고 <re>클라우드 서비스를 이용할 수 있도록 지원하는 제도</re><br/><br/>\
* 근거 : <br/>\
<re>『클라우드 컴퓨팅 발전 및 이용자 보호에 관한 법률』 제5조</re>에 의한 『제1차 클라우드 컴퓨팅 기본계획』(2015)의 클라우드 보안인증제 시행 『클라우드 컴퓨팅 서비스 정보보호에 관한 기준 고시』 제7조에 따른 정보보호 기준의 준수여부 확인 (과학기술정보통신부 고시 제2017-7호)<br/><br/>\
* 인증 기준<br/><br/>\
  - <gr>IaaS</gr> 인증은 관리적·물리적기술적 보호조치 및 공공기관용 추가 보호조치로 총<gr>14개</gr> 분야 <gr>117개 통제항목</gr>으로 구성<br/>\
  - <gr>SaaS</gr> 표준등급 인증은 관리적·기술적 및 공공기관용 추가 보호조치로 총 <gr>13개</gr> 분야 <gr>78개 통제항목</gr>으로 구성 (8. 물리적 보안 제외)<br/>\
  - <gr>SaaS</gr> 간편등급 인증은 관리적·기술적 및 공공기관용 추가 보호조치로 총 <gr>11개</gr> 분야 <gr>30개 통제항목</gr>으로 구성 (3. 자산관리, 4. 서비스 공급망 관리, 8. 물리적 보안 제외)<br/>\
  - <gr>DaaS</gr> 인증은 관리적·물리적·기술적 및 공공기관용 추가 보호조치로 총 <gr>14개</gr> 분야 <gr>110개 통제항목</gr>으로 구성<br/>\
<br/><br/>\
* 통제 분야 :<br/>\
1.  정보보호 정책 및 조직<br/>\
2.  인적보안<br/>\
...
11.  네트워크 보안<br/>\
12.  데이터 보호 및 암호화<br/>\
13.  시스템 개발 및 도입 보안<br/>\
14.  공공부문 추가 보안요구 사항<br/>\
',
);
