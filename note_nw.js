...
'<re>OSI 7 계층</re>',
'<re>서비스 프리미티브(Service Primitive)</re>',
'<re>[Layer2]- Service</re>',
'<re>[Layer2]- 회선제어</re>',
'<re>[Layer2]- 오류제어</re>',
'<re>[Layer2][오류제어][FEC]- 해밍코드</re>',
'<re>[해밍코드]- 해밍거리</re>',
'<re>[Layer2][오류제어][BEC]- CRC</re>',
'<re>[Layer2][오류제어][BEC]- Parity Check</re>',
'<re>[Layer2][오류제어][BEC]- Check Sum</re>',
'<re>[Layer2][오류제어][BEC]- ARQ</re>',
'<re>흐름제어</re>',
'<re>[흐름제어]- Sliding Window</re>',
'<re>[흐름제어]- Stop and Wait</re>',
'<re>[Layer2][접근제어]- CSMA/CD</re>',
'<re>[Layer2][접근제어]- CSMA/CA</re>',
'<re>[Layer2]- Frame Relay</re>',
'<re>[Layer2]- Collison Domain</re>',
'<re>[Layer3]- 공증교환 데이터망(PSDN) 방식</re>',
'<re>[Layer3]- 회선교환</re>',
'<re>[Layer3]- 패킷교환</re>',
'<re>[Layer3]- 패킷데이터 네트워크 계층 오류</re>',
'<re>[Layer3]- 라우팅</re>',
'<re>[Layer3]- 거리벡터 라우팅</re>',
'<re>[Layer3]- 링크스테이트 라우팅</re>',
'<re>[Layer3]- IGMP</re>',
'<re>Layer4</re>',
'<re>[Layer4]- Service</re>',
'<re>[Layer4]- TCP 혼잡제어</re>',
'<re>[Layer4]- TCP</re>',
'<re>[Layer4][TCP]- SSL/TLS</re>',
'<re>[Layer4][UDP]- DTLS</re>',
'<re>DHCP</re>',
'<re>DNS</re>',
'<re>IP Tunneling</re>',
'<re>Web RTC</re>',
...
'<re>[Web RTC]- RTP</re>',
'<re>[Web RTC]- SCTP</re>',
'<re>[Internet]- 인터넷 프로토콜 3단계 주소체계</re>',
'<re>[Internet]- HTTP/2.0</re>',
'<re>[Internet]- HTTP/3.0</re>',
'<re>[HTTP/3.0]- QUIC</re>',
'<re>[Internet]- IPSec</re>',
'<re>Network IP(Subnetting, Supernetting)</re>',
'<re>[Internet]- IPv6</re>',
'<re>[IPv6]- 헤더구성</re>',
'<re>[IPv6]- 전환기술</re>',
'<re>[IPv6]- 패킷 단편화</re>',
'<re>[IPv6]- ICMPv6</re>',
'<re>[IPv6]- 보안취약성 및 대응방안</re>',
'<re>VLSM</re>',
'<re>Subnet</re>',
'<re>Subnetting</re>',
'<re>Supernetting</re>',
...
'<re>[전송부호화]- 소스코딩</re>',
'<re>[소스코딩]- 압축기술</re>',
'<re>[소스코딩][무손실 압축]- Run Length Coding</re>',
'<re>[소스코딩][무손실 압축]- Huffman Coding</re>',
'<re>[소스코딩][혼합 압축]- MPEG</re>',
'<re>[전송부호화]- 채널코딩</re>',
'<re>[전송부호화]- 라인코딩</re>',
'<re>Modbus</re>',
'<re>필드버스(Fieldbus)</re>',
'<re>[필드버스(Fieldbus)]- IEEE802.11i, IEEE 802.11ac, IEEE 802.11ah(M2M-Wifi), IEEE 803.af(Super Wifi)</re>',
'<re>[무선통신]- Wi-SUN</re>',
'<re>[무선통신]- Wi-Fi Positioning System</re>',
'<re>[무선통신]- 와이파이 헤일로(W-Fi HaLow)</re>',
'<re>[무선통신]- 와이파이 콜링 서비스(Wi-Fi calling Service)</re>',
'<re>[무선통신]- 패시브 와이파이(Passive wifi)</re>',
'<re>[무선통신]- 인지무선(Cognitive Radio)</re>',
'<re>[무선통신]- IEEE 802.11p</re>',
'<re>[무선통신]- C-V2X</re>',
'<re>[무선통신]- Gigabit WLAN</re>',
'<re>[무선통신]- 저전력 무선통신 비교</re>',
'<re>[무선통신][저전력]- 블루투스 5</re>',
'<re>[무선통신][저전력]- UWB</re>',
'<re>[측위기술]- LBS</re>',
'<re>[측위기술]- IPS</re>',
'<re>[측위기술]- LDT</re>',
'<re>[측위기술]- GPS</re>',
'<re>[측위기술][GPS]- 위성항법기술</re>',
'<re>[측위기술][GPS]- SBAS</re>',
'<re>[측위기술]- RTLS</re>',
'<re>라이파이(Li-Fi)</re>',
'<re>SON</re>',
...
'<re>[5G]- 5G NSA</re>',
'<re>[5G]- 5G SA</re>',
'<re>[5G]- 3GPP Release 16</re>',
'<re>[5G]- MEC</re>',
'<re>[MEC]- SSL Offloading</re>',
'<re>[5G]- 5GX</re>',
'<re>[5G]- Open Lan</re>',
'<re>[5G]- Network Slicing</re>',
'<re>[5G]- Private 5G</re>',
'<re>지능형 초연결망</re>',
'<re>6G</re>',
'<re>[6G]- 6G 추진 전략</re>',
...
'<re>Wifi 6e</re>',
'<re>재난 안전 통신망</re>',
'<re>[재난 안전 통신망]- LTE-M</re>',
'<re>[재난 안전 통신망]- LTE-R</re>',
'<re>[재난 안전 통신망]- RAN Sharing</re>',
'<re>D2D</re>',
'<re>토르 네트워크(Tor Network)</re>',
'<re>비지상네트워크(NTN, Non-Terrestrial Network)</re>',
'<re>eMTC</re>',
'<re>Network Storage</re>',
'<re>자가망 구축 가이드라인</re>',
'<re>QoS</re>',
'<re>[QoS]- WFQ</re>',
'<re>[QoS]- 통합 서비스</re>',
'<re>[QoS]- 차등 서비스</re>',
'<re>[QoS][차등][Queuing]- Priority Queue</re>',
'<re>[QoS][차등][Queuing]- Custom Queue</re>',
'<re>FTP</re>',
'<re>[FTP]- FTPS</re>',
'<re>[FTP]- SFTP</re>',
'<re>Socket</re>',
