...
- <re>SW의 양적/질적 수준</re>을 <re>측정</re>하여 소유자원 및 기간산정 등을 계획, 수립하는 활동 <br/><br/>\
# 암기 <br/>\
- <bl>하 : 델전</bl> <br/>\
- <bl>상 : LM </bl><br/>\
- <bl>수 : CF</bl> <br/><br/>\
...
- 양적 수준 중시 <br/><br/>\
# COCOMO 유형</bl> <br/>\
1. <bl>Basic</bl> COCOMO <br/>\
- LOC로 SW개발 노력/비용 추정<br/>\
- <bl>단일값</bl> 모형<br/>\
- 스텝수 계산 방식 <br/><br/>\
2. <bl>Intermidiate</bl> <br/>\
- 프로젝트 형태 <br/>\
- 개발환경 <br/>\
- 개발인력요소 따라 <bl>15개 특성치</bl> 적용 <br/>\
1) 제품속성 : 신뢰도, 복잡도, DB크기 <br/>\
2) HW 속성 : 응답시간, 성능제약 <br/>\
3) 인적 속성 : 분석가능력, 경험 <br/>\
4) 프로젝트 속성 : 일정, 개발도구, 방법론 <br/><br/>\
3.<bl> Detailed</bl> <br/>\
- <bl>3계층 비용</bl>산정 : 모듈레벨, 서브시스템레벨, 시스템별 산정후 합산 <br/><br/>\
# <gr>PJT</gr> 유형 <br/>\
- 단순형(<gr>Ora</gr>ganic) <br/>\
- 중간형(<gr>Semi</gr>-detached) <br/>\
- 임베디드형(<gr>Emb</gr>edded) <br/><br/>\
# 문제점 <br/>\
...
- <re>계획대비 실적</re>을 확인하는 기법으로 프로젝트의 <re>일정과 비용</re>이 단위를 동일한 <re>화폐가치로 환산</re>하여 통합관점에서 성과측정을 하고자하는 <re>원가관리 기법</re> <br/><br/>\
<img src = "./img/EVM.png" style = "max-width:100%; height:auto;">\
',

// 델파이 기법
'# 정의 : <re>의견 불일치시</re> 타협통한 <re>중재안 도출</re>하고 <re>조정자</re>에 의해 편견 분위기 배제하여 무기명, 반복 재산정 통한 <re>전문가 집단의 의견합의를 유도하는 방법</re> \
',
...
- <gr>보</gr>안커설팅(투) <br/>\
*구현단계 (SW개발비(투,기)) <br/>\
2. <bl>운영</bl>단계 (<re>유운고S사재지관-가</re>) <br/>\
- 유지관리(요율)<br/>\
- 운영(투)<br/>\
- 운영/유지관리(고정비/변동비)<br/>\
...
# <bl>컨</bl>설팅<bl>지수</bl> 방식 의한 ISP 수립비 : 투입공수 파악 어려운 경우, 업무 난이도 의존적 <br/>\
- 업무범위 설정 <br/>\
...
# <bl>투</bl>입공수 방식에 의한 ISP 수립비 : 컨설팅 지수로 산정 불가하 대형 사업, 투입공수 산정 가능한 경우, 컨설턴트 수준 의존적, 사업 예산 및 예정 가격 산정 용도로만 활용 <br/>\
...
- <gr>절</gr>차 : 각 기능이 <gr>순차적 수행</gr>되는 모듈 (<bl>init() look() end()</bl>) <br/>\
- <gr>통</gr>신 : 각 기능이 <gr>동일 입출력 모듈</gr> 사용 (<bl>A(a) B(a)</bl>) <br/>\
- <gr>순</gr>차 : <gr>전 단계의 결과값</gr>을 입력으로 사용 (<bl>t=A(a), B(t)</bl>) <br/>\
- <gr>기</gr>능 : <gr>단일 기능만</gr> 수행하는 모듈 (높음) <br/>\
',
...
- <gr>외</gr>부 : 모듈이 <gr>외부자료</gr> 참조 (<bl>#include a.pc</bl>) <br/>\
- <gr>공</gr>유 : 모듈이 <gr>전역변수</gr> 참조 (<bl>static int a</bl>)<br/>\
- <gr>내</gr>용 : <gr>다른 모듈의 내용</gr> 참조 (<bl>goto A</bl>) (높음) <br/><br/>\
...
# <gr>구성요소</gr> <br/>\
1. <bl>식별</bl> <br/>\
- <gr>대상 시스템</gr> : App, Sub System <br/>\
- <gr>이해 관계자</gr> : System Concern 갖고 있는 개인, 기관 등 <br/>\
- <gr>관심사</gr> : 시스템에서의 관심 사항 <br/><br/>\
2. <bl>표현</bl> <br/>\
- <gr>모델형</gr> : 모델링 타입 방식 <br/>\
- <gr>아키텍처</gr> : 환경에서 시스템의 기본 개념 또는 속성 <br/>\
- <gr>아키텍처 기술</gr> : 아키텍처 표현에 사용되는 방법 <br/><br/>\
3. <bl>AD Part</bl> <br/>\
- <gr>View Point</gr> : 규칙 정의 패턴, 템플릿 <br/>\
- <gr>Model</gr> : 생각, 견해로부터 시스템 표현 <br/>\
- <gr>결정 근거</gr> : 선택, 설계된 아키텍처 대한 논리적 근거 <br/>\
- <gr>대응 관계 규제</gr> : View 들간의 규칙 <br/>\
- <gr>대응 관계</gr> : 이해관계자 관심 따른 대응 관계 <br/><br/>\
# IEEE 1471와 비교 설명 <br/>\
...
- 아키텍처 설계에서 반복적, 일반적 발생 문제를 해결하고 아키텍처가 만족시켜야 하는 <re>시스템 품질 속성 달성 위한 Best Practice를 정리한 패턴</re> <br/><br/>\
# 기능 <br/>\
- 기본 스키마 제시 <br/>\
- 서브시스템 제공 <br/>\
- 패턴간 책임 명시 <br/>\
...
- 한 객체의 <re>상태</re>가 바뀌는 경우 <re>의존관계</re> 있는 다른 객체들에게 연락이 가고, <re>자동</re>으로 그 내용이<re>갱신</re>되도록 일대다 의존성을 정의한 행위 패턴 <br/><br/>\
# 구성 <br/>\
- Interface : Subejct, Observer <br/>\
- Class : <bl>ConcreateSubject</bl>(<gr>Get</gr>ter, <gr>Set</gr>ter), <bl>ConcreteObserver</bl>(<gr>Upd</gr>ate()) <br/><br/>\
# 특징 <br/>\
- 느슨한 결합 <br/>\
- 일관성 보장 \
',
...
// [시험단계]- 테스트 하네스
'# 정의 : <re>시험 지원 목적</re> 코드, 데이터 <br/>\
- 시스템 및 시스템 컴포넌트를 시험하는 환경의 일부분으로 시험을 지원하는 목적하에 생성된 코드와 데이터 <br/><br/>\
# 구성 (<bl>스하드상</bl>) <br/>\
- <re>Test Stub</re> : 가상의 하위 모듈, 하향식(Top Down), 호출되어 결과값을 리턴 <br/>\
- <re>Test Driver</re> : 가상의 상위 모듈, 상향식(Bottom-Up)에 필요, 호출 기능만을 수행 <br/><br/>\
# 활용 : TUD, 자산화하여 회귀테스트 자동화에 활용 \
',

// 테스트 더블
'# 정의 :<re> 대체 위한 테스트용 객체</re><br/>\
- 오리지널 객체 사용 어려운 경우, 실제구성요소 서버를 대체 위한 테스트용 객체 <br/><br/>\
# 유형 <br/>\
- <bl>Dummy Object</bl> : 구현제외 I/F, 객체자체 기능x <br/>\
- <bl>Test Stub</bl> : 기본 클래스 최소구현, 로직x, 값리턴 <br/>\
- <bl>Test Spy</bl> : 인스턴스 Client 제공, 호출멤버확인, 이력 <br/>\
- <bl>Fake Object</bl> : 완전구성, 느리거나 DB 미구성 <br/>\
- <bl>Mock Objecdt</bl> : Lib 사용 동적 데이터 처리 \
',
...
- 타켓 시스템에서 발생하는 <bl>사용자 입력 및 외부 이벤트를 기록해서 테스트 스크립트로 구성</bl>하고 이를 재수행하여 결과를 확인하는 방법<br/><br/>\
# 암기 <br/>\
...
- 테스트 수행결과 판단하기 위해 <bl>미리 정의한 참 값을 대입</bl>하여 비교하는 방법 <br/><br/>\
# 특징 <br/>\
- 제한된 검증 <br/>\
- 수학적 기법 <br/>\
- 전문지식 <br/>\
...
// 회귀 테스트
'# 정의 : 변경후 검증 테스트 <br/>\
- 프로그램 <bl>변경후 영향 받는 기존 프로그램의 테스트</bl>를 수행하여 신규결함 유입여부를 검증하는 테스트 기법 <br/><br/>\
# 목적 <br/>\
- <re>Ripple</re> Effect : 파급효과 <br/>\
- <re>Side</re> Effect : 부작용 <br/><br/>\
# 절차 <br/>\
- Smoke Test <br/>\
- Test 진행 <br/>\
- 결과 기록 및 사후 검증 <br/><br/>\
...
- <bl>상상 : STA</bl>(엄격한 Server Test Area) 재테스팅 <bl>3회</bl>, Full Regession Test <br/>\
- <bl>상하 : SSTA</bl>(강한 Strong Test Area) 재테스팅 <bl>2회</bl>, Full Regession Test <br/>\
- <bl>하상 : ITA</bl>(집중 Intensive Test Area) 재테스팅 <bl>1회</bl>, Partial Regession Test <br/>\
- <bl>하하 : FTA</bl>(기본 Fundamental Test Area) 재테스팅 <bl>1회</bl>, 확인 테스트 <br/><br/>\
# 유사 개념 <br/>\
- 결함 테스트 : 미발견 결함 탐색<br/>\
- 확인 테스트 : 수정 결과 확인 <br/>\
- 회귀 테스트 : 영향테스트 <br/><br/>\
...
- <re>자원제약사항을 고려</re>하여 계획수립시 과다하게 설정될 수 있는 여유시간을 줄여 \
통합된 버퍼로 책정하고 <re>버퍼의 소진율을 모니터링</re>하여 전체 <re>프로젝트 일정을 관리</re>하는 기법 <br/><br/>\
# 납기 지연 4가지 법칙 (<bl>파자후학</bl>)<br/>\
...
// Lehman 소프트웨어 변화
'# 정의 : 소프트웨어는 요구에 의해 계속적으로 변경되며, 변경에 따른 복잡성, 프로그램의 고유한 변경 추세, SW조직 생산성의 일관성, <re>소프트웨어</re> 각 버전의 <re>변화</re>에 대한 <re>일관성</re>을 제시한 <re>SW 변화의 원리</re> <br/><br/>\
# 소프트웨어 분류 <br/>\
...
- <bl>감</bl>사 : SW Baseline 무결성 평가 수단 / 계획서, 보고서 <br/>\
- <bl>기</bl>록 : 형상 및 변경관리 대한 기록, 보고서 작성 / 상태 기록 문서, 상태 보고서 <br/><br/>\
# 도구 <br/>\
1. 저장관리 측면 <br/>\
...
// WBS
'# 정의 : 실행작업 <re>인도물 중심 분할 계층구조 체계</re> <br/>\
...
// Resource Leveling
'# 정의 : 자원 조정 기법 <br/>\
- 자원의 한계에 따라 시작일과 종료일을 조정하는 기법, <re>자원의 양/사용가능기간 한정</re>되거나, <re>동시에 두개 이상의 활동에 포함된 경우</re> 이를 조정해주는 방법 <br/><br/>\
# 유형 <br/>\
- <bl>자원 고정형</bl> : 자원제한, 제한된 자원 조건하 최단기간 <br/>\
- <bl>시간 고정형</bl> : 자원무제한, 기간제한 <br/><br/>\
# 절차 <br/>\
1. CPM 계산 <br/>\
2. 자원히스토그램 작성 <br/>\
3. 평균화 최적값 도출 <br/>\
...
// 브룩스 법칙
'# 정의 : 커뮤니케이션 비대 역효과 <br/>\
- 지연되는 프로젝트에 <bl>인력을 더 투입하면 오히려 일정이 지연</bl>됨 <br/><br/>\
...
- 원가 통제 <br/><br/>\
# 원가 산정 기법 <br/>\
- <gr>유사</gr>산정, <gr>모수</gr>산정, <gr>3점</gr>산정, <gr>상향식</gr>산정, <gr>예비비</gr> 분석, <gr>품질 비용</gr> \
',
...
- QC 7가지 도구가 수치데이터를 해석, <re>신 QC 7가지 도구</re>는 <re>언어데이터</re>를 이용하여 문제를 분석하는 <re>정성적 방법</re> <br/><br/>\
# <bl>구성</bl> <br/>\
- <bl>친</bl>화도 <br/>\
- <bl>연</bl>관도 <br/>\
- <bl>계</bl>통도 <br/>\
...
// 터크만 팀 발달 5단계
'# 정의 : 그룹 개발 모델 <br/>\
- <bl>조직</bl>이 <bl>성장</bl>하고 도전에 대응하고 문제의식을 갖고 해결책을 찾으며 작업계획을 세우고 결과를 전달하기 위해 <bl>필요한 5가지 단계</bl>를 표현한 <bl>그룹개발 모델</bl> <br/><br/>\
# 사이클 (<re>형격규성해 탐준형실휴</re>)<br/>\
- 형성기(탐색) <br/>\
- 격동기(준비) <br/>\
- 규범기(형성) <br/>\
- 성과기(실행) <br/>\
...
# 위험의 <gr>범주</gr> <br/>\
- <gr>Project</gr> Risk : 일정 및 비용 증가 위험 <br/>\
- <gr>Techincal</gr> Risk : 구현이 어려워지거나 불가능 해지는 위험 <br/>\
- <gr>Business</gr> Risk : 생존 가능성에 대한 위협 <br/><br/>\
# 위험의 <gr>종류</gr> <br/>\
- <gr>Known</gr> Risk : 발견된 위험, 관리 계획을 통해 대응 가능 <br/>\
- <gr>Predictable</gr> Risk : 과거 경험을 통해 예측 가능한 위험, 관리 계획 통해 대응 가능 <br/>\
- <gr>Unpredictable</gr> Risk : 사전 예측이 어려운 위험, 계획 수립 불가, 예비비 통한 대응 <br/><br/>\
* 그리타\
',
...
- <bl>강</bl>화 : 긍정 영향 식별, 극대화 / 컨설팅<br/>\
- <bl>수</bl>용 : 활용하지만, 기회추구 x / 무대응<br/><br/>\
# 고려사항 <br/>\
...
# Boehm 제시 프로젝트 10대 <gr>위험</gr>요소 <br/>\
- <gr>개인적</gr> 부족<br/>\
- <gr>일정, 예산, 프로</gr>세스<br/>\
- <gr>기존</gr>의 <gr>상업적 상품</gr>, 외부 구성 요소<br/>\
- <gr>요구 사항 불일치</gr><br/>\
- 사용자 인터페이스 불일치<br/>\
- <gr>아키텍처</gr>, 성능, 품질<br/>\
- <gr>요구 사항 변경</gr><br/>\
- <gr>레거시</gr> 소프트웨어<br/>\
- <gr>외부적으로 실행</gr>되는 작업<br/>\
- 제한적인 컴퓨터 과학<br/><br/>\
* 125회 관리 2교시 2번\
',
...
- <re>EMV = 성공했을때 수익 * 성공확률 - 실패했을때의 수익 * 실패확률</re> <br/><br/>\
# 사례 <br/>\
...
- 일정과 원가 간의 <re>트레이드-오프를 고려</re>하여 자원할당을 조정하는 프로젝트 일정관리의 <re>자원 최적화 기법</re> <br/><br/>\
# 기법 <br/>\
- <bl>리소스 레벨링</bl> : 자원 한계, 일정 지연 / <bl>주공정 변경</bl> / Total Float 0 이상 <br/>\
- <bl>리소스 스무딩</bl> : 일정 한계, 자원 최적화 / <bl>주공정 변경 x</bl> / Free Float ~ Total Float 내 <br/><br/>\
...
// 요르돈 법칙
'# 정의 : <re>초기 체계적 필요 법칙</re> <br/>\
- <re>개발초기에 체계적 분석, 설계 수행</re>되지 않으면 후반에 상대적으로 커진다는 법칙 <br/><br/>\
# 품질비용 : <bl>1:10:100의 법칙</bl> <br/><br/>\
# 프로젝트 유형 <br/>\
...
# 표준 모델 <br/>\
- <bl>제품품질</bl> : ISO <bl>9126</bl>, ISO <bl>14598</bl>, ISO <bl>12119</bl>, ISO <bl>9001</bl>, <bl>9002</bl>, ISO <bl>25000</bl><br/>\
- SW <re>프로세스 품질</re> : ISO <re>12207</re>, <re>CMMI</re>, <re>SPICE</re> <br/>\
- 품질경영 : 6 시그마, ISO 9000 \
',
...
// 품질평가
'# 정의 : SW 제품이 <re>요구사항과 일치하는지 확인</re>하는 체계적이고 계획적인 작업 <br/><br/>\
...
- 사용자가 요구하는 소프트웨어 제품의 품질을 구체화하였으며, 소프트웨어의 품질에 영향을 미치는 요소들을 제품<re>운영</re>, 제품<bl>개선</bl>, 제품<bl>변환</bl>과 같이 세 가지 측면으로 분류하고 이들에게 각각 적용할 수 있는 척도를 제시하고 소프트웨어가 요구된 제품 품질을 달성하기 위해 얼마나 진행되었는지 파악할 수 있도록 지표를 제시 <br/><br/>\
# 구성 <br/>\
...
- 개별적으로 개발된 <re>기존의 SW 품질표준</re>들을 하나로 <re>통합</re>한 SW 품질평가 국제 표준 <br/><br/>\
# 기반 표준 <br/>\
...
// ISO 12207
'# 정의 : 체계적인 소프트웨어 획득, 공급, 개발, 운영 및 유지보수를 위해서 <re>소프트웨어 생명주기 공정 표준을 제공</re>함으로써, 소프트웨어 실무자들이 개발 및 관리에 동일한 언어로 <re>의사소통할 수 있는 기본틀</re>을 제공하기 위한 프로세스<br/><br/>\
# 암기 <br/>\
...
// 지식재산권
'# 정의 : 인간의 지적 창작물 보호 <br/>\
- 인간의 창조적 활동 또는 경험 등을 통해 창출하거나 발견한 지식,정보,기술이나 표현, 표시 그 밖에 무형적인 것으로서 재산적 가치가 실현될 수 있는<bl>지적 창작물에 부여된 재산에 관한 권리</bl> <br/><br/>\
# 종류 <br/>\
- 산업 재산권 : 특허, 실용신안, 디자인, 상표 <br/>\
- 저작권 : 저작권, 저작인접권(음악제작자) <br/>\
- 신지식재산권 : 첨단사업재산권(AI), 산업저작권(SW), 정보재산권(DB, 영업비밀) <br/><br/>\
# 보호 기술 <br/>\
- <gr>난독</gr>화 : Reverse Engineering 방지 <br/>\
- <gr>Finger</gr> printing : 저작권 정보 삽입 <br/>\
- <gr>Water</gr> mark : 저작자 정보 삽입 <br/>\
- <gr>Enc</gr>ryption : 전체 알고리즘 적용 \
',
...
// 원격지 개발
'# 정의 : 소프트웨어 기업이 <re>고객의 통제없이 독립된 공간과 분리된 공정</re>으로 소프트웨어 개발 결과를 서비스하는 방법 <br/><br/>\
# 필요성 : <bl>인력활용</bl> 증대, IT <bl>기술 고도</bl>화, 글로벌 <bl>역량</bl> 강화, <bl>비용</bl>절감 <br/><br/>\
# 구성 : 온사이트(요구분석, 분석), 원격(설계, 개발, 테스트) <br/><br/>\
# 문제점 : 부정확한 <bl>산출물</bl>, <bl>중계자</bl> 부재, <bl>전달 체계</bl> 미흡, <bl>요구사항 변경</bl> 대응 문제 <br/><br/>\
# 해결방안 : <bl>중계</bl>자, <bl>원격 개발방법론</bl>(사용자 스토리, <bl>TDD</bl>, <bl>애자일</bl> 기반 프로세스, 산출물 테스트) \
',
...
// Multiple V Model
'# 정의 : <bl>Model</bl>, <bl>Proto</bl>type, <bl>Final</bl> Product Model <br/>\
...
// 구조적 방법론
'# 정의 : <re>요구사항</re> 및 <re>문서화</re> 기반 SW 개발 방법론 / <re>모듈화 하향식 분할</re> 수행 <br/>\
- 소프트웨어 모듈화를 위해 하향식 분할의 분석/설계 수행하며 사용자 요구사항 및 문서화를 기반으로 소프트웨어를 개발하는 방법론<br/><br/>\
# 특징 <br/>\
- <bl>프로세스 중심</bl> <br/>\
- <bl>Top Down 방식</bl> : 정보공학과 동일 <br/>\
- <bl>분할과 정</bl>복 : 정보공학과 동일 <br/>\
- <bl>단계적/절차적 Waterfall 기반</bl> <br/><br/>\
# 단계<br/>\
1. <gr>구조적 분석</gr> : 도형중심, Top Down방식 기능 분해 <br/>\
- 산출물 : DFD, ERD, STD(상태전이도), Mini-Spec(소기능명세서), Data Dictionary(자료 사전) <br/>\
2. <gr>구조적 설계</gr> : 추상화, 결합도, 응집도 고려<br/>\
- 산출물 : Structure Chart, 프로그램 명세서, Multi-Level DFD <br/>\
3. <gr>구조적 개발</gr> : 계층적 형식, 제한된 제어구조, 작성순서대로 PG실행 <br/>\
...
// CRUD 매트릭스
'# 정의 : <re>상관관계 분석 매트릭스</re> <br/>\
- Data의 Create, Read, Update, Delete를 업무 Process와 매칭한 <re>프로세스와 데이터 모델링</re>의 상관관계 분석 매트릭스 <br/><br/>\
# 절차 <br/>\
- <gr>ERD 분석</gr> 및 작성 <br/>\
- <gr>업무 기능 분해도</gr> 작성 <br/>\
- <gr>CRUD Matrix</gr> 작성 \
',
...
# 특징 (생고재편기관사) <br/>\
- <re>생</re>산성 : 시간 단축 <br/>\
- <re>고</re>품질 : 품질 검증 컴포넌트 사용 <br/>\
- <re>재</re>사용성과 대치성 : 실행기반의 재사용 <br/>\
- <re>변</re>경 용이성 : 요구사항 변화 수용 안정적 <br/>\
- <re>기</re>술 집약석 : 기술 숙련에 대한 집중 <br/>\
- <re>관</re>리 용이성 : 독립적인 컴포넌트 단위의 관리로 복잡성 최소 <br/>\
- <re>사</re>용자 중심 <br/><br/>\
...
- <bl>지속적으로 Quality Control을 적용</bl>하는 프로세스 실행 Practice <br/><br/>\
# 특징 <br/>\
- 초기 발견<br/>\
- 짧은 사이클 <br/>\
- 빈번한 적용,빌드,자동화 <br/><br/>\
...
*<re>모델링</re> : 모든 모델의 수명주기를 조율하고 AI의 롤아웃 및 유지 관리를 효과적으로 자동화하고 지속적으로 향상<br/>\
*운영 : 소프트웨어 엔지니어 또는 데이터 과학자와 IT 간의 사일로를 제거<br/><br/>\
*도입단계:<br/>\
1) 현재상황파악<br/>\
2) 변화의 촉진<br/>\
3) 문화적 공감대<br/>\
...
- <re>데이터 분석 결과</re>를 쉽게 이해할 수 있도록 <re>시각적으로 표현</re>하고 전달하는 <re>과정</re>(TTA)<br/><br/>\
# 암기 <br/>\
...
- 4단계 : <bl>Work Package 관리</bl>, 인수기준 상세화 <br/>\
- 5단계 : Work Package <bl>실제 수준 상세</bl>화 <br/><br/>\
# <gr>작성원칙</gr> <br/>\
- <gr>관리 가능</gr> 크기 : 할당가능, 소통가능<br/>\
- <gr>분할 레벨</gr> 구분 : 3~5단계<br/>\
- <gr>작업 패키지의 적정</gr> 크기 : 1 ~ 10% 정도 <br/>\
- WBS <gr>100%</gr> : 총합 100 <br/><br/>\
* KPC 25회 3교시 2번\
',
...
// PMO, 감리
'- 관점 : <re>3자</re> 관점(독립적) / <re>발주자</re> 관점<br/>\
- 법적근거 : <bl>57.1 의무</bl> / <bl>64.2 권고</bl> <br/>\
...
# 기술 분류 (<bl>구데제예</bl>)<br/>\
- <bl>구획</bl> 난독화 : 형식 변화, 주석제거 <br/>\
- <bl>데이터</bl> 난독화 : 변수 나누거나 합치기 <br/>\
- <bl>제어</bl> 난독화 : 문장 묶는 단위 조절 <br/>\
- <bl>예방</bl> 난독화 : 방법 봉쇄<br/><br/>\
# 적용사례 <br/>\
<img src = "./img/Obfuscation.png" style = "max-width:100%; height:auto;">\
',

// 함수형 언어
'# 개념 : <re>함수가 First Class</re> 대상인 언어 <br/>\
- 명령형 언어의 부작용을 제거하기 위해 <re>참조 투명성을 제공하는 수학적 Pure 함수의 모듈화</re>를 이용한 프로그래밍을 지원하는 언어 <br/>\
...
// 로우코드
'# 정의 : 코딩없는 프로그램 개발 <br/>\
- 조직의 특정 프로세스 및 데이터 요구사항 처리를 위한 응용 프로그램을 신속하게 만들어 사용하기 위해 <re>그래픽 사용자 인터페이스 및 기능 구성을 이용</re>하여 응용 프로그램을 개발하는 환경 <br/><br/>\
# 장점 <br/>\
1. 개발관점 <br/>\
- 개발속도 향상 : <bl>Drap and Drop</bl> <br/>\
- 생산성 향상 : <bl>오브젝트 연결</bl> <br/><br/>\
2. 운영관점 <br/>\
...
// 민간투자형 SW사업
'# 정의 : <re>국민생활</re>의 <re>편익 증진</re>을 위해 민간의 자본과 기술을 활용하여 <re>민간과 공공이 협력</re>, 추진하는 공공 SW 사업 <br/><br/>\
# 종류 <br/>\
...
// 정보시스템 운영 성과관리
'# 정의 : <re>정보시스템 운영타당성</re>을 판단하기 위한 정해진 기준에 따라 <re>성과</re>를 <re>측정</re>하고, 그 결과에 따라 정보시스템의 효율적 운영을 위한 <re>유지관리유형을 결정</re>하여 업무 및 비용 측면의 성과를 높이기 위한 <re>제반활동</re> <br/><br/>\
# 적용근거 <br/>\
- 전자정부법 제45조 제3항 및 제4항 : 행정기관등의 장이 그 소관 정보시스템 운영타당성 판단 <br/>\
- 정보시스템 운영 성과관리지침 <br/><br/>\
# 지표 <br/>\
1. <bl>비용</bl>측면 <br/>\
- <bl>운</bl>영의 <bl>적정</bl>성 : 누적 유지보수 비율 <br/>\
- <bl>비</bl>용의 <bl>효율</bl>성 : 평균 운영유지비용 증감률 <br/>\
- <bl>유</bl>지의 <bl>용이</bl>성 : 투입 운영유지비용 증감률 <br/><br/>\
2. <bl>업무</bl>측면 <br/>\
- <bl>업</bl>무수행 <bl>영향</bl>도 : 기능 활용도 <br/>\
- <bl>사</bl>용상의 <bl>편의</bl>성 : 사용 편의성 <br/>\
- <bl>업</bl>무성과 <bl>달성</bl>도 : 목표대비 성과 달성도 / 업무성과 증감률 <br/><br/>\
# 성과측정 절차 <br/>\
1. <gr>1차 성과측정</gr> 절차 <br/>\
- <gr>대상 식별</gr> : 5년이상 운영 정보시스템 <br/>\
- 기초데이터 수집 <br/>\
- 데이터 신뢰성 점검 <br/>\
- 성과측정 <br/><br/>\
2. <gr>2차 성과측정</gr> 절차 <br/>\
- <gr>유형 분류</gr> : 유지관리, 유형별 재분류 <br/>\
- 자원 효율성 측정 <br/>\
- 구축방안 정의: 현행분석, 요구사항정의. 범위결정, 구축방안 도출 <br/>\
- 투자타당성 분석 : 경제성, 정성적 효과 <br/>\
- <gr>최종</gr> 의사<gr>결정</gr> : <gr>유</gr>지, <gr>재</gr>개발, 통<gr>폐</gr>합, 폐<gr>기</gr> <br/><br/>\
* 116회 응용 2교시 6번\
',

// 공공기관 사업자 선정
'# 정의 : 국가계약법, 지방계약법, 협상에 의한 계약체결 기준, <re>행정기관 및 공공기관 정보시스템 구축 운영 지침</re> <br/>\
- 국가/지방 계약법을 근거로 한 구축업체 선정 방식 <br/><br/>\
# 종류 <br/>\
- <bl>협</bl>상에 의한 계약 체결 방식 <br/>\
- <bl>낙</bl>찰자 결정 방식 <br/>\
- <bl>경</bl>쟁적 대화 방식 : 아이디어 협의, 경쟁 통한 최적 결정 <br/><br/>\
...
// 협상 의한 계약체결 방식
'# 정의 : 제안서, 가격 입찰서 <br/>\
- <bl>제안서나 가격 입찰서를 받아 평가</bl> 후 협상 절차를 거쳐 <gr>낙찰자 선정 방식</gr> <br/><br/>\
# 특징 <br/>\
...
# 법적근거 <br/>\
- 소프트웨어산업 진흥법 : 제54조(국가기관등의 상용 소프트웨어 구매) <br/>\
