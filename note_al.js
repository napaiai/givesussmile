...
'<re>[선형]- Stack</re>',
'<re>[선형]- Queue</re>',
'<re>[선형]- Priority Queue</re>',
'<re>[비선형]- Heap</re>',
'<re>[알고리즘 설계]- Back Tracking</re>',
'<re>[알고리즘 설계]- 분할과정복</re>',
'<re>[알고리즘 설계]- Greedy</re>',
'<re>[알고리즘 설계]- 동적계획법</re>',
'<re>트라이(Trie)</re>',
'<re>정렬 알고리즘</re>',
'<re>[정렬 알고리즘]- Selection sort</re>',
'<re>[정렬 알고리즘]- Bubble sort</re>',
'<re>[정렬 알고리즘]- Insertion sort</re>',
'<re>[정렬 알고리즘]- Shell sort</re>',
'<re>[정렬 알고리즘]- Merge sort</re>',
'<re>[정렬 알고리즘]- Quick sort</re>',
'<re>최단경로 알고리즘</re>',
'<re>[최단경로 알고리즘]- 다익스트라(Dijkstra) 알고리즘</re>',
'<re>[최단경로 알고리즘]- 플로이드(Floyd) 알고리즘</re>',
'<re>[최단경로 알고리즘]- 벨만-포드(Bellman-Ford algorithm) 알고리즘</re>',
'<re>[최단경로 알고리즘]- A* 알고리즘</re>',
'<re>최소신장트리</re>',
'<re>[최소신장트리]- 크루스칼(Kruskal) 알고리즘</re>',
'<re>[최소신장트리]- 프림(Prim) 알고리즘</re>',
'<re>[Tree]- AVL Tree</re>',
'<re>[Tree]- Multiway Search Tree</re>',
'<re>[Tree]- B Tree</re>',
'<re>[Tree]- B Plus Tree</re>',
'<re>[Tree]- B Star Tree</re>',
'<re>[Tree]- 2 3 Tree</re>',
'<re>[Tree]- Red Black Tree</re>',
'<re>방향성 비순환 그래프</re>',
'<re>[방향성 비순환 그래프]- 위상 정렬</re>',
'<re>[AI]- 인공지능 특이점</re>',
'<re>[AI]- 인공지능 데이터 평가</re>',
'<re>[AI]- 기계학습</re>',
'<re>[AI]- 지도학습</re>',
'<re>[AI]- Clustering</re>',
'<re>[AI]- 능동학습</re>',
'<re>[AI][지도학습]- 머신러닝 예측모델</re>',
'<re>[AI][지도학습]- 성능검증</re>',
'<re>[AI][지도학습][성능검증]- Cross Validation</re>',
'<re>[AI][지도학습][성능검증]- 혼동행렬(오차행렬)</re>',
'<re>[AI][지도학습][성능검증]- ROC Curve</re>',
'<re>[AI][지도학습]- 분류모델생성알고리즘</re>',
'<re>[AI][지도학습][AL]- ANN</re>',
'<re>[AI]- DNN</re>',
'<re>[AI][지도학습][AL]- SVM</re>',
'<re>[AI]- 비지도 학습</re>',
'<re>[AI][비지도학습]- 차원축소</re>',
'<re>[AI][비지도학습][AL]- PCA Algorithm</re>',
'<re>[AI][비지도 학습]- GAN</re>',
'<re>[AI][비지도 학습]- DCGAN</re>',
'<re>[AI]- 강화학습</re>',
'<re>[AI][강화학습]- 심층강화학습</re>',
'<re>[AI]- 역강화학습</re>',
...
'<re>[AI][Classifier][AL]- Backpropagation</re>',
'<re>[AI][Classifier][AL]- Gradient Descent</re>',
'<re>[AI][Classifier][AL]- Optimizer</re>',
'<re>[AI]- 비용함수, 손실함수</re>',
'<re>[AI][Classifier][AL]- KNN</re>',
'<re>[AI][Classifier]- 로지스틱 회귀분석</re>',
'<re>[AI][Clustering][AL]- DBSCAN</re>',
'<re>[AI][Clustering][AL]- EM Clustering</re>',
'<re>[AI][Clustering][AL]- Dendrogram CLustering</re>',
'<re>[AI][Clustering][AL]- K-means</re>',
'<re>[AI][Clustering][AL]- SOM</re>',
'<re>[AI][AL]- MCTS</re>',
'<re>[AI][AL]- CNN</re>',
'<re>[AI][CNN]- Efficient NET, DET</re>',
'<re>[AI][AL]- R-CNN</re>',
'<re>[AI][AL][R-CNN]- Fast RCNN</re>',
'<re>[AI][AL][R-CNN]- Faster RCNN</re>',
'<re>[AI][AL][R-CNN]- YOLO</re>',
'<re>[AI][AL]- RNN</re>',
'<re>[AI][AL][RNN]- BRNN</re>',
'<re>[AI][AL]- LSTM</re>',
'<re>[AI][AL]- GRU</re>',
'<re>[AI][AL]- GNN</re>',
'<re>[AI]- 딥러닝</re>',
'<re>[AI][DeepLearning]- 딥러닝 한계점</re>',
'<re>[AI][DeepLearning]- 컨텍스트 딥러닝</re>',
'<re>[AI][DeepLearning]- 튜링테스트</re>',
'<re>[AI][DeepLearning]- Vanishing Gradient Problem</re>',
'<re>[AI][DeepLearning]- Drop Out</re>',
'<re>[AI]- F1-Score</re>',
'<re>[AI]- Bias</re>',
'<re>[AI]- One-Hot Encoding</re>',
'<re>[AI]- Softmax 함수</re>',
'<re>[AI]- NPU</re>',
'<re>[AI]- Deep Fake</re>',
'<re>[AI]- Hyper Prameter</re>',
'<re>[AI]- Computer Vision</re>',
'<re>[AI][Computer Vision]- OpenCV</re>',
'<re>[AI]- 머신러닝 파이프라인</re>',
'<re>[AI]- Active Learning</re>',
'<re>[AI]- AutoML</re>',
'<re>[AI]- 역기능</re>',
'<re>[AI]- 인공지능 편향</re>',
'<re>[AI]- 인공지능 감성지능</re>',
'<re>[AI]- 앙상블 학습법</re>',
'<re>[AI]- Fitting</re>',
'<re>[AI][Fitting]- Overfitting</re>',
'<re>[AI][Fitting]- Underfitting</re>',
'<re>[AI]- Python</re>',
'<re>[AI][DL FW]- (1) TensorFlow</re>',
'<re>[AI][DL FW]- (2) PyTorch</re>',
'<re>[AI]- 모방학습</re>',
'<re>[AI]- 연합학습</re>',
'<re>[AI]- 딥러닝 경량화</re>',
'<re>[AI][딥러닝 경량화]- 경량 딥러닝 기술</re>',
'<re>[AI][딥러닝 경량화]- 알고리즘 경량화</re>',
'<re>[AI][알고리즘 경량화]- 지식 증류</re>',
'<re>[AI][AL]- Q-러닝</re>',
'<re>[AI]- 모라벡의 역설(Moravec\'s Paradox)</re>',
'<re>[AI]- 인공지능 서비스 플랫폼</re>',
'<re>[AI]- 인공지능 소프트웨어 보안 취약성</re>',
'<re>[AI]- AI Flow</re>',
'<re>[AI]- XAI</re>',
'<re>[AI][지식표현]- 생성규칙</re>',
'<re>[AI][지식표현]- 의미망</re>',
'<re>[AI][의미망]- 프레임</re>',
'<re>[AI][지식표현]- 논리</re>',
'<re>[AI]- 클라우드 활용 AI구축 모델</re>',
'<re>[AI]- AI 프로젝트</re>',
'<re>[AI][정책]- 한국판 AI 윤리기준</re>',
'<re>[AI]- 인공지능 규범 동향</re>',
'<re>[AI]- 인공지능 국가전략</re>',
'<re>[AI]- 인공지능 개인정보보호 자율점검표</re>',
'<re>[AI]- 적대적 공격</re>',
'<re>[AI]- 음성비서</re>',
'<re>[AI]- Pre-Crime</re>',
'<re>[AI]- 지능형 로봇</re>',
...
'<re>[AI][NLP]- 워드 임베딩</re>',
'<re>[AI][NLP]- TF-IDF</re>',
'<re>[AI][NLP]- Word2Vec</re>',
'<re>[AI][NLP]- Attention</re>',
'<re>[AI][NLP]- Transformer</re>',
'<re>[AI][NLP]- BERT</re>',
'<re>[AI][NLP]- GPT-3</re>',
'<re>[AI]- 전이학습</re>',
'<re>[AI][비지도][자기지도]- Downstream Task</re>',
'<re>[AI]- 추천 시스템</re>',
'<re>[AI][정책]- AI 조달 가이드라인</re>',
'<re>[AI]- Digital Cartel</re>',
'<re>[AI]- 인공지능 성능 지표</re>',
'<re>[AI][성능지표]- IoU</re>',
'<re>CCW(CounterClockWise) 알고리즘</re>',
);
