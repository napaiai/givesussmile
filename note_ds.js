...
'<re>4차산업 혁명</re>',
'<re>[4차산업]- Smart City</re>',
'<re>Smart City 보안</re>',
'<re>[Smart City]- 지능형 CCTV</re>',
'<re>CCTV 개인영상 보호방안</re>',
'<re>[4차산업]- Smart Work</re>',
'<re>[4차산업]- Smart Energy</re>',
'<re>Smart Grid</re>',
'<re>[Smart Grid]- AMI</re>',
'<re>[Smart Grid]- 보안</re>',
'<re>[Smart Grid]- Micro Grid</re>',
'<re>[Smart Grid]- 인터미턴트 컴퓨팅</re>',
'<re>[Smart Grid]- IDPP</re>',
'<re>산업제어시스템</re>',
'<re>[산업제어시스템]- Purdue Model</re>',
'<re>[4차산업]- Smart Factory</re>',
'<re>Smart Factory 보안</re>',
'<re>[Smart Factory]- MESA 표준기능</re>',
'<re>[Smart Factory]- ANSI/ISA 95</re>',
'<re>[Smart Factory]- RAMI 4.0</re>',
'<re>[Smart Factory]- CPS</re>',
'<re>[Smart Factory]- CPS 요구사항</re>',
'<re>[Smart Factory]- SCADA</re>',
'<re>[Smart Factory]- 팝업팩토리(Pop-up Factory)</re>',
'<re>Smart Pharm</re>',
'<re>IoT</re>',
'<re>[IoT-통신]- NB-IoT</re>',
'<re>[IoT-서비스]- IoT Platform</re>',
'<re>[IoT-서비스][IoT Platform]- oneM2M Mobius</re>',
'<re>[IoT-서비스][IoT Platform]- OCF</re>',
'<re>[IoT-서비스][IoT Platform]- OPC UA</re>',
'<re>[4차산업]- Smart Hospital</re>',
'<re>[4차산업]- Smart Car</re>',
'<re>자율주행 자동차</re>',
'<re>자율주행 자동차 보안</re>',
'<re>[자율주행]- 트롤리 딜레마</re>',
'<re>[자율주행]- 모랄머신</re>',
'<re>[자율주행]- 군집주행 (Platooning)</re>',
'<re>[자율주행]- LDM</re>',
'<re>[자율주행]- C-ITS</re>',
'<re>[자율주행]- Lidar</re>',
'<re>[자율주행]- Radar</re>',
...
'<re>[정책]- K뉴딜</re>',
'<re>[정책][뉴딜]- 디지털 뉴딜</re>',
'<re>[정책][디지털뉴딜]- 데이터 댐</re>',
'<re>[정책][뉴딜]- 그린 뉴딜</re>',
'<re>[정책][뉴딜]- SoC 디지털화</re>',
'<re>[정책]- 지능 정보화 기본법</re>',
'<re>Flipped Learning</re>',
'<re>디지털 사이니지(Digital Signage)</re>',
'<re>[디지털 사이니지(Digital Signage)] - 오픈스크린</re>',
'<re>[디지털 사이니지(Digital Signage)] - 오픈스크린 프로젝트</re>',
'<re>의료기술</re>',
'<re>[의료기술]- ISO 62304</re>',
'<re>[의료기술]- ISO 14971</re>',
'<re>[의료기술]- ISO 13485</re>',
'<re>[의료기술]- ISO 25237</re>',
'<re>[의료기술]- 의료 AI</re>',
'<re>[의료기술]- 차세대 Healthcare service</re>',
'<re>기능성 게임</re>',
'<re>OTT(Over the top)</re>',
'<re>[OTT]- 웹인증 API</re>',
'<re>인증기술</re>',
'<re>[인증기술]- 바이오 인증</re>',
'<re>[인증기술]- 얼굴인식 알고리즘</re>',
'<re>[인증기술]- 자기주권형 신원증명</re>',
'<re>[인증기술]- DID</re>',
'<re>[인증기술]- GADI</re>',
'<re>[인증기술]- 바이오정보 분산관리</re>',
'<re>[인증기술]- 전자 여권</re>',
'<re>[인증기술]- 비대면 실명 인증</re>',
'<re>디바이스 DNA</re>',
'<re>Solid - Social Linked Data</re>',
'<re>앰비언트 커머스</re>',
'<re>핀테크</re>',
'<re>[핀테크]- 서비스</re>',
'<re>[핀테크]- 핀테크 오픈플랫폼</re>',
'<re>[핀테크]- 핀테크 오픈플랫폼 보안가이드</re>',
'<re>[핀테크]- 인슈어테크</re>',
'<re>[핀테크]- 인터넷 전문 은행</re>',
'<re>[핀테크]- FDS</re>',
'<re>[핀테크]- 마이데이터 산업</re>',
'<re>[마이데이터]- 마이데이터 본허가 취득</re>',
'<re>[마이데이터]- 금융분야 마이데이터 서비스 가이드라인</re>',
'<re>[마이데이터]- 데이터 전송요구권</re>',
'<re>[핀테크]- Scraping</re>',
'<re>[핀테크]- API</re>',
'<re>[핀테크]- QR코드 기반 결제</re>',
'<re>[핀테크]- Zero Pay</re>',
'<re>[핀테크]- 스마트 지갑</re>',
'<re>[마이데이터]- 데이터 주권 이슈</re>',
'<re>[마이데이터]- PDS</re>',
'<re>아바커스 프로젝트(Project Abacus)</re>',
'<re>오감기술</re>',
'<re>멀티 모달</re>',
'<re>모션기술</re>',
'<re>Web 2.0</re>',
'<re>[Web 2.0]- Ajax</re>',
'<re>[Web 2.0]- CCL</re>',
'<re>[Web 2.0]- Folksonomy</re>',
'<re>[Web 2.0]- Enterprise 2.0</re>',
'<re>[Web 2.0]- Web Syndication</re>',
'<re>[Web 2.0]- SPA</re>',
'<re>[Web 3.0]- PWA</re>',
'<re>[Web 3.0]- Service Worker</re>',
'<re>[Web 3.0]- React.js</re>',
'<re>[Web 3.0]- REST</re>',
'<re>[Web]- XML, JSON</re>',
'<re>[JSON]- JWT</re>',
'<re>Semantic Web</re>',
'<re>웹 접근성</re>',
'<re>[N Screen]- Responsive Web Design</re>',
'<re>[N Screen]- Adaptive Web Design</re>',
'<re>시선통신기술(Line of Sight Communications)</re>',
'<re>[음성인식]- 하이퍼보이스(Hypervioice)</re>',
'<re>모바일 컨시어지(Mobile Concierge)</re>',
'<re>NUI</re>',
'<re>제로 UI</re>',
'<re>감정 인식 기술</re>',
'<re>데이터브로커</re>',
'<re>가상화</re>',
'<re>가상머신, 컨테이너</re>',
'<re>[가상화]- 하이퍼바이저(Hypervisor)</re>',
'<re>[가상화]- 컨테이너</re>',
'<re>[가상화]- 컨테이너 오케스트레이션</re>',
'<re>[가상화]- 도커(Docker)</re>',
'<re>[가상화][도커]- LXC</re>',
'<re>[가상화]- 쿠버네티스(Kubernetes)</re>',
'<re>[가상화]- Converged Infrastructure</re>',
'<re>[가상화]- HCI</re>',
'<re>[가상화]- Appliance Server</re>',
'<re>[가상화]- VDI</re>',
'<re>[GIS]- OGC</re>',
'<re>[GIS]- IMDF</re>',
'<re>위치정보, 위치기반서비스</re>',
'<re>IEC 61508</re>',
'<re>[ISO/IEC 61508]- SIL</re>',
'<re>[ISO/IEC 61508]- ASIL</re>',
'<re>[ISO/IEC 61508]- 26262</re>',
'<re>HILS, HIL 시뮬레이션</re>',
'<re>오픈뱅킹(Open Banking)</re>',
'<re>IoMT</re>',
'<re>암호화폐 용어</re>',
'<re>블록체인</re>',
'<re>[블록체인]- 블록체인 트릴레마</re>',
'<re>블록체인 종류</re>',
'<re>[블록체인]- 블록체인 3.0</re>',
'<re>[블록체인]- 합의 알고리즘</re>',
'<re>[합의 알고리즘]- PoW</re>',
'<re>[블록체인]- Hard Fork, Soft Fork</re>',
'<re>[블록체인]- UTXO</re>',
'<re>[블록체인]- 머클트리(Merkle Tree)</re>',
'<re>[블록체인]- 블록체인 오라클 문제</re>',
'<re>[블록체인]- 스마트시티 활용</re>',
'<re>[블록체인]- Off Chain</re>',
'<re>[블록체인][Off Chain]- Side Chain</re>',
'<re>[블록체인][Off Chain]- 라이트닝 네트워크</re>',
'<re>[블록체인]- 블록체인 거버넌스</re>',
'<re>[블록체인]- 플랫폼 보안</re>',
'<re>[블록체인]- BaaS</re>',
'<re>[블록체인]- NFT</re>',
'<re>[블록체인]- De-Fi</re>',
'<re>[블록체인]- ICO</re>',
'<re>[블록체인]- KYC</re>',
'<re>[블록체인]- 영지식 증명(Zero-knowledge Proof)</re>',
'<re>[블록체인][영지식 증명]- zk-SNARK</re>',
'<re>[블록체인] - 스마트계약(Smart Contract)</re>',
'<re>[블록체인][Smart Contract]- Smart Contract Audit</re>',
'<re>[블록체인][취약점] - solidity 6대 취약</re>',
'<re>[블록체인]- 하이퍼레저 프로젝트</re>',
'<re>[블록체인][하이퍼레저]- 하이퍼레저 패브릭</re>',
'<re>CBDC</re>',
'<re>MaaS</re>',
'<re>Dark Net</re>',
'<re>RPA</re>',
'<re>Process Mining</re>',
'<re>클라우드 컴퓨팅</re>',
'<re>[클라우드]- 클라우드 전환</re>',
'<re>[클라우드]- IaaS, PaaS, SaaS</re>',
'<re>[클라우드]- IaC</re>',
'<re>[클라우드]- KAMP</re>',
'<re>[클라우드]- PaaS-TA</re>',
'<re>[클라우드]- 클라우드 보안이슈</re>',
'<re>[클라우드][정책]- 정보자원등급 평가기준(2014.04.)</re>',
'<re>[클라우드][정책]- 클라우드 보안인증제</re>',
'<re>[클라우드][보안인증]- DaaS 인증</re>',
'<re>[클라우드][정책]- 디지털서비스 전문계약제도</re>',
'<re>[클라우드][정책]- 디지털서비스 전문시스템</re>',
'<re>[클라우드]- Grid Computing</re>',
'<re>[클라우드]- Utility Computing</re>',
'<re>[클라우드]- Fog Computing</re>',
'<re>[클라우드]- CSB</re>',
'<re>[클라우드]- MSP</re>',
'<re>[클라우드]- 인터클라우드</re>',
'<re>[클라우드]- 멀티 클라우드</re>',
'<re>[클라우드]- 클라우드 네이티브 컴퓨팅</re>',
'<re>[클라우드]- 클라우드 네이티브 애플리케이션</re>',
'<re>[클라우드][개발 방법론]- 12 Factors</re>',
'<re>[클라우드]- 메시지 큐잉</re>',
'<re>[메시지 큐잉]- Kafka</re>',
'<re>[클라우드]- 차세대 방향성</re>',
'<re>[클라우드]- 오픈 스택</re>',
'<re>[클라우드][오픈스택]- Swift</re>',
'<re>[클라우드]- Open Shift</re>',
'<re>[클라우드]- PPP 클라우드</re>',
'<re>엣지 컴퓨팅</re>',
'<re>레그테크</re>',
'<re>섭테크</re>',
'<re>프롭테크</re>',
'<re>[HPC]- Singularity</re>',
'<re>2020년 하반기 경제정책 방향</re>',
'<re>로보 어드바이저</re>',
'<re>검색엔진</re>',
'<re>[검색엔진]- 색인어 추출</re>',
'<re>HTML 5</re>',
'<re>[공공데이터]- Open Data Platform</re>',
'<re>[공공데이터][Open Data]- LOD</re>',
'<re>Data Warehouse</re>',
'<re>[공공데이터]- Data Lake</re>',
'<re>[공공데이터][Data Lake]- Data Catalogs</re>',
'<re>[공공데이터]- 공공데이터 품질관리 메뉴얼 V2.0</re>',
'<re>Open API</re>',
'<re>[Open API]- SOAP API</re>',
'<re>[Open API]- REST API</re>',
'<re>[Open API]- OAuth2.0</re>',
'<re>[Open API]- OAS</re>',
'<re>API Gateway</re>',
'<re>Ontact</re>',
'<re>비대면 기술</re>',
...
'<re>Web Crawling</re>',
'<re>오픈소스 소프트웨어</re>',
'<re>[오픈소스]- 오픈소스 라이선스</re>',
'<re>[오픈소스]- 오픈소스 라이선스 분류</re>',
'<re>[오픈소스 라이선스]- GPL</re>',
'<re>[오픈소스 라이선스]- LGPL</re>',
'<re>[오픈소스 라이선스]- BSD</re>',
'<re>[오픈소스 라이선스]- Apache</re>',
'<re>[오픈소스 라이선스]- MPL</re>',
'<re>[오픈소스 라이선스]- InnerSource</re>',
'<re>[오픈소스]- 오픈소스 거버넌스</re>',
'<re>[오픈소스]- 오픈소스 수익모델</re>',
'<re>[오픈소스]- 오픈소스 프로젝트관리 소프트웨어</re>',
'<re>[디지털 정책]- 디지털 디바이드</re>',
'<re>[디지털 정책]- 디지털 리터러시</re>',
'<re>[디지털 정책]- 디지털 포용</re>',
'<re>Web 4.0</re>',
'<re>XR</re>',
'<re>[XR]- VR</re>',
'<re>[VR]- 주변감지 및 경고 시스템</re>',
'<re>[XR]- AR</re>',
'<re>[XR]- 메타버스</re>',
'<re>[XR]- 실감협업</re>',
'<re>E-Learning</re>',
...
'<re>[로봇]- URC</re>',
'<re>[로봇]- SLAM</re>',
'<re>[Gartner 2020]- Democratization</re>',
'<re>[Gartner 2021][People Centricity]- IoB</re>',
'<re>[Gartner 2021][People Centricity]- 전체 경험</re>',
'<re>[Gartner 2021][People Centricity]- 개인정보보호 강화 컴퓨팅</re>',
'<re>[Gartner 2021][Location Independence]- 분산 클라우드</re>',
'<re>[Gartner 2021][Location Independence]- 어디서나 운영</re>',
'<re>[Gartner 2021][Location Independence]- 사이버 보안 메시</re>',
