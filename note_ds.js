...
',
// 6대 취약점
'# 정의 : 스마트 컨트랙트 플랫폼에서 발생한 6대 취약점 <br/>\
- 1) 오버/언더플로            -> 해결책 : 오픈제플린,세이프매쓰 <br/>\
- 2) 메세지호출,접근권한제어   -> 해결책 : n/a <br/>\
- 3) 리엔트런시              -> 해결책 : 하드포크 <br/>\
- 4) 짧은 주소공격            -> 해결책 : 짧은경우 예외처리,유효성검사 <br/>\
- 5) 잔액조건 무효화         -> 해결책 : 잔액조건 유의 <br/>\
- 6) DoS 보안               -> 해결책 : 지속적 보안업데이트 <br/>\
