...
'<span>4차산업 혁명</span>',
'<span>[4차산업]- Smart City</span>',
'<span>Smart City 보안</span>',
'<span>[Smart City]- 지능형 CCTV</span>',
'<span>CCTV 개인영상 보호방안</span>',
'<span>[4차산업]- Smart Work</span>',
'<span>[4차산업]- Smart Energy</span>',
'<span>Smart Grid</span>',
'<span>[Smart Grid]- AMI</span>',
'<span>[Smart Grid]- 보안</span>',
'<span>[Smart Grid]- Micro Grid</span>',
'<span>[Smart Grid]- 인터미턴트 컴퓨팅</span>',
'<span>[Smart Grid]- IDPP</span>',
'<span>산업제어시스템</span>',
'<span>[산업제어시스템]- Purdue Model</span>',
'<span>[4차산업]- Smart Factory</span>',
'<span>Smart Factory 보안</span>',
'<span>[Smart Factory]- MESA 표준기능</span>',
'<span>[Smart Factory]- ANSI/ISA 95</span>',
'<span>[Smart Factory]- RAMI 4.0</span>',
'<span>[Smart Factory]- CPS</span>',
'<span>[Smart Factory]- CPS 요구사항</span>',
'<span>[Smart Factory]- SCADA</span>',
'<span>[Smart Factory]- 팝업팩토리(Pop-up Factory)</span>',
'<span>Smart Pharm</span>',
'<span>IoT</span>',
'<span>[IoT-통신]- NB-IoT</span>',
'<span>[IoT-서비스]- IoT Platform</span>',
'<span>[IoT-서비스][IoT Platform]- oneM2M Mobius</span>',
'<span>[IoT-서비스][IoT Platform]- OCF</span>',
'<span>[IoT-서비스][IoT Platform]- OPC UA</span>',
'<span>[4차산업]- Smart Hospital</span>',
'<span>[4차산업]- Smart Car</span>',
'<span>자율주행 자동차</span>',
'<span>자율주행 자동차 보안</span>',
'<span>[자율주행]- 트롤리 딜레마</span>',
'<span>[자율주행]- 모랄머신</span>',
'<span>[자율주행]- 군집주행 (Platooning)</span>',
'<span>[자율주행]- LDM</span>',
'<span>[자율주행]- C-ITS</span>',
'<span>[자율주행]- Lidar</span>',
'<span>[자율주행]- Radar</span>',
'<span>[자율주행]- ADAS</span>',
'<span>[자율주행]- 자율운항 선박</span>',
'<span>안티드론</span>',
'<span>[정책]- 데이터 거버넌스</span>',
'<span>[정책]- K뉴딜</span>',
'<span>[정책][뉴딜]- 디지털 뉴딜</span>',
'<span>[정책][디지털뉴딜]- 데이터 댐</span>',
'<span>[정책][뉴딜]- 그린 뉴딜</span>',
'<span>[정책][뉴딜]- SoC 디지털화</span>',
'<span>[정책]- 지능 정보화 기본법</span>',
'<span>Flipped Learning</span>',
'<span>디지털 사이니지(Digital Signage)</span>',
'<span>[디지털 사이니지(Digital Signage)] - 오픈스크린</span>',
'<span>[디지털 사이니지(Digital Signage)] - 오픈스크린 프로젝트</span>',
'<span>의료기술</span>',
'<span>[의료기술]- ISO 62304</span>',
'<span>[의료기술]- ISO 14971</span>',
'<span>[의료기술]- ISO 13485</span>',
'<span>[의료기술]- ISO 25237</span>',
'<span>[의료기술]- 의료 AI</span>',
'<span>[의료기술]- 차세대 Healthcare service</span>',
'<span>기능성 게임</span>',
'<span>OTT(Over the top)</span>',
'<span>[OTT]- 웹인증 API</span>',
'<span>인증기술</span>',
'<span>[인증기술]- 바이오 인증</span>',
'<span>[인증기술]- 얼굴인식 알고리즘</span>',
'<span>[인증기술]- 자기주권형 신원증명</span>',
'<span>[인증기술]- DID</span>',
'<span>[인증기술]- GADI</span>',
'<span>[인증기술]- 바이오정보 분산관리</span>',
'<span>[인증기술]- 전자 여권</span>',
'<span>[인증기술]- 비대면 실명 인증</span>',
'<span>디바이스 DNA</span>',
'<span>Solid - Social Linked Data</span>',
'<span>앰비언트 커머스</span>',
'<span>핀테크</span>',
'<span>[핀테크]- 서비스</span>',
'<span>[핀테크]- 핀테크 오픈플랫폼</span>',
'<span>[핀테크]- 핀테크 오픈플랫폼 보안가이드</span>',
'<span>[핀테크]- 인슈어테크</span>',
'<span>[핀테크]- 인터넷 전문 은행</span>',
'<span>[핀테크]- FDS</span>',
'<span>[핀테크]- 마이데이터 산업</span>',
'<span>[마이데이터]- 마이데이터 본허가 취득</span>',
'<span>[마이데이터]- 금융분야 마이데이터 서비스 가이드라인</span>',
'<span>[마이데이터]- 데이터 전송요구권</span>',
'<span>[핀테크]- Scraping</span>',
'<span>[핀테크]- API</span>',
'<span>[핀테크]- QR코드 기반 결제</span>',
'<span>[핀테크]- Zero Pay</span>',
'<span>[핀테크]- 스마트 지갑</span>',
'<span>[마이데이터]- 데이터 주권 이슈</span>',
'<span>[마이데이터]- PDS</span>',
'<span>아바커스 프로젝트(Project Abacus)</span>',
'<span>오감기술</span>',
'<span>멀티 모달</span>',
'<span>모션기술</span>',
'<span>Web 2.0</span>',
'<span>[Web 2.0]- Ajax</span>',
'<span>[Web 2.0]- CCL</span>',
'<span>[Web 2.0]- Folksonomy</span>',
'<span>[Web 2.0]- Enterprise 2.0</span>',
'<span>[Web 2.0]- Web Syndication</span>',
'<span>[Web 2.0]- SPA</span>',
'<span>[Web 3.0]- PWA</span>',
'<span>[Web 3.0]- Service Worker</span>',
'<span>[Web 3.0]- React.js</span>',
'<span>[Web 3.0]- REST</span>',
'<span>[Web]- XML, JSON</span>',
'<span>[JSON]- JWT</span>',
'<span>Semantic Web</span>',
'<span>웹 접근성</span>',
'<span>[N Screen]- Responsive Web Design</span>',
'<span>[N Screen]- Adaptive Web Design</span>',
'<span>시선통신기술(Line of Sight Communications)</span>',
'<span>[음성인식]- 하이퍼보이스(Hypervioice)</span>',
'<span>모바일 컨시어지(Mobile Concierge)</span>',
'<span>NUI</span>',
'<span>제로 UI</span>',
'<span>감정 인식 기술</span>',
'<span>데이터브로커</span>',
'<span>가상화</span>',
'<span>가상머신, 컨테이너</span>',
'<span>[가상화]- 하이퍼바이저(Hypervisor)</span>',
'<span>[가상화]- 컨테이너</span>',
'<span>[가상화]- 컨테이너 오케스트레이션</span>',
'<span>[가상화]- 도커(Docker)</span>',
'<span>[가상화][도커]- LXC</span>',
'<span>[가상화]- 쿠버네티스(Kubernetes)</span>',
'<span>[가상화]- Converged Infrastructure</span>',
'<span>[가상화]- HCI</span>',
'<span>[가상화]- Appliance Server</span>',
'<span>[가상화]- VDI</span>',
'<span>[GIS]- OGC</span>',
'<span>[GIS]- IMDF</span>',
'<span>위치정보, 위치기반서비스</span>',
'<span>IEC 61508</span>',
'<span>[ISO/IEC 61508]- SIL</span>',
'<span>[ISO/IEC 61508]- ASIL</span>',
'<span>[ISO/IEC 61508]- 26262</span>',
'<span>HILS, HIL 시뮬레이션</span>',
'<span>오픈뱅킹(Open Banking)</span>',
'<span>IoMT</span>',
'<span>암호화폐 용어</span>',
'<span>블록체인</span>',
'<span>[블록체인]- 블록체인 트릴레마</span>',
'<span>블록체인 종류</span>',
'<span>[블록체인]- 블록체인 3.0</span>',
'<span>[블록체인]- 합의 알고리즘</span>',
'<span>[합의 알고리즘]- PoW</span>',
'<span>[블록체인]- Hard Fork, Soft Fork</span>',
'<span>[블록체인]- UTXO</span>',
'<span>[블록체인]- 머클트리(Merkle Tree)</span>',
'<span>[블록체인]- 블록체인 오라클 문제</span>',
'<span>[블록체인]- 스마트시티 활용</span>',
'<span>[블록체인]- Off Chain</span>',
'<span>[블록체인][Off Chain]- Side Chain</span>',
'<span>[블록체인][Off Chain]- 라이트닝 네트워크</span>',
'<span>[블록체인]- 블록체인 거버넌스</span>',
'<span>[블록체인]- 플랫폼 보안</span>',
'<span>[블록체인]- BaaS</span>',
'<span>[블록체인]- NFT</span>',
'<span>[블록체인]- De-Fi</span>',
'<span>[블록체인]- ICO</span>',
'<span>[블록체인]- KYC</span>',
'<span>[블록체인]- 영지식 증명(Zero-knowledge Proof)</span>',
'<span>[블록체인][영지식 증명]- zk-SNARK</span>',
'<span>[블록체인] - 스마트계약(Smart Contract)</span>',
'<span>[블록체인][Smart Contract]- Smart Contract Audit</span>',
'<span>[블록체인][취약점] - solidity 6대 취약</span>',
'<span>[블록체인]- 하이퍼레저 프로젝트</span>',
'<span>[블록체인][하이퍼레저]- 하이퍼레저 패브릭</span>',
'<span>CBDC</span>',
'<span>MaaS</span>',
'<span>Dark Net</span>',
'<span>RPA</span>',
...
'<span>클라우드 컴퓨팅</span>',
'<span>[클라우드]- 클라우드 전환</span>',
'<span>[클라우드]- IaaS, PaaS, SaaS</span>',
'<span>[클라우드]- IaC</span>',
'<span>[클라우드]- KAMP</span>',
'<span>[클라우드]- PaaS-TA</span>',
'<span>[클라우드]- 클라우드 보안이슈</span>',
'<span>[클라우드][정책]- 정보자원등급 평가기준(2014.04.)</span>',
'<span>[클라우드][정책]- 클라우드 보안인증제</span>',
'<span>[클라우드][보안인증]- DaaS 인증</span>',
'<span>[클라우드][정책]- 디지털서비스 전문계약제도</span>',
'<span>[클라우드][정책]- 디지털서비스 전문시스템</span>',
'<span>[클라우드]- Grid Computing</span>',
'<span>[클라우드]- Utility Computing</span>',
'<span>[클라우드]- Fog Computing</span>',
'<span>[클라우드]- CSB</span>',
'<span>[클라우드]- MSP</span>',
'<span>[클라우드]- 인터클라우드</span>',
'<span>[클라우드]- 멀티 클라우드</span>',
'<span>[클라우드]- 클라우드 네이티브 컴퓨팅</span>',
'<span>[클라우드]- 클라우드 네이티브 애플리케이션</span>',
'<span>[클라우드][개발 방법론]- 12 Factors</span>',
'<span>[클라우드]- 메시지 큐잉</span>',
'<span>[메시지 큐잉]- Kafka</span>',
'<span>[클라우드]- 차세대 방향성</span>',
'<span>[클라우드]- 오픈 스택</span>',
'<span>[클라우드][오픈스택]- Swift</span>',
'<span>[클라우드]- Open Shift</span>',
'<span>[클라우드]- PPP 클라우드</span>',
'<span>엣지 컴퓨팅</span>',
'<span>레그테크</span>',
'<span>섭테크</span>',
'<span>프롭테크</span>',
'<span>[HPC]- Singularity</span>',
'<span>2020년 하반기 경제정책 방향</span>',
'<span>로보 어드바이저</span>',
'<span>검색엔진</span>',
'<span>[검색엔진]- 색인어 추출</span>',
'<span>HTML 5</span>',
'<span>[공공데이터]- Open Data Platform</span>',
'<span>[공공데이터][Open Data]- LOD</span>',
'<span>Data Warehouse</span>',
'<span>[공공데이터]- Data Lake</span>',
'<span>[공공데이터][Data Lake]- Data Catalogs</span>',
'<span>[공공데이터]- 공공데이터 품질관리 메뉴얼 V2.0</span>',
'<span>Open API</span>',
'<span>[Open API]- SOAP API</span>',
'<span>[Open API]- REST API</span>',
'<span>[Open API]- OAuth2.0</span>',
'<span>[Open API]- OAS</span>',
...
'<span>오픈소스 소프트웨어</span>',
'<span>[오픈소스]- 오픈소스 라이선스</span>',
'<span>[오픈소스]- 오픈소스 라이선스 분류</span>',
'<span>[오픈소스 라이선스]- GPL</span>',
'<span>[오픈소스 라이선스]- LGPL</span>',
'<span>[오픈소스 라이선스]- BSD</span>',
'<span>[오픈소스 라이선스]- Apache</span>',
'<span>[오픈소스 라이선스]- MPL</span>',
'<span>[오픈소스 라이선스]- InnerSource</span>',
'<span>[오픈소스]- 오픈소스 거버넌스</span>',
'<span>[오픈소스]- 오픈소스 수익모델</span>',
'<span>[오픈소스]- 오픈소스 프로젝트관리 소프트웨어</span>',
'<span>[디지털 정책]- 디지털 디바이드</span>',
'<span>[디지털 정책]- 디지털 리터러시</span>',
'<span>[디지털 정책]- 디지털 포용</span>',
'<span>Web 4.0</span>',
'<span>XR</span>',
'<span>[XR]- VR</span>',
'<span>[VR]- 주변감지 및 경고 시스템</span>',
'<span>[XR]- AR</span>',
'<span>[XR]- 메타버스</span>',
'<span>[XR]- 실감협업</span>',
...
'<span>[로봇]- URC</span>',
'<span>[로봇]- SLAM</span>',
'<span>[Gartner 2020]- Democratization</span>',
'<span>[Gartner 2021][People Centricity]- IoB</span>',
'<span>[Gartner 2021][People Centricity]- 전체 경험</span>',
'<span>[Gartner 2021][People Centricity]- 개인정보보호 강화 컴퓨팅</span>',
'<span>[Gartner 2021][Location Independence]- 분산 클라우드</span>',
'<span>[Gartner 2021][Location Independence]- 어디서나 운영</span>',
'<span>[Gartner 2021][Location Independence]- 사이버 보안 메시</span>',
'<span>[Gartner 2021][Resilient Delivery]- 지능형 구성 가능한 비즈니스</span>',
'<span>[Gartner 2021][Resilient Delivery]- AI 엔지니어링</span>',
'<span>[Gartner 2021][Resilient Delivery]- 초자동화</span>',
...
// 6대 취약
'# 정의 : 스마트 컨트랙트 플랫폼에서 발생한 6대 보안 취약점 <br/>\
1)오버/언더플로 - 오픈제플린,세이프매쓰<br/>\
2)메세지 호출,접근권한 제어 - public권한 유의<br/>\
3)리엔트런시 - 하드포크 <br/>\
4)짧은 주소공격 - 예외처리,유효성검사<br/>\
5)잔액조건 무효화 -보호장치 유의<br/>\
6)DoS공격 - 지속보안 대응<br/>\
',
