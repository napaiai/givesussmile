...
'<re>ITSM</re>',
'<re>[ITSM]- SoW/SLA/SLM</re>',
'<re>[ITSM]- SLA</re>',
'<re>[ITSM][SLA]- Penalty/Incentive</re>',
'<re>[ITSM][SLA]- SIP</re>',
'<re>[ITSM][SLA]- Annual Reset</re>',
'<re>[ITSM]- OLA</re>',
'<re>[ITSM]- SLM</re>',
'<re>아웃소싱 운영관리 메뉴얼</re>',
'<re>[ITSM]- 장애 관리</re>',
...
'<re>[IT-BS]- IT 투자</re>',
'<re>[IT-BS]- IT 투자 성과 평가</re>',
'<re>[IT-BS]- IT 투자 평가 항목</re>',
'<re>나라장터 </re>',
'<re>COBIT 5.0</re>',
'<re>IT-Compliance</re>',
'<re>규제 샌드박스</re>',
...
'<re>Value Chain</re>',
'<re>MVP</re>',
'<re>IT 거버넌스 프레임워크(IT Governance Framework)</re>',
);
...
<img src = "./img/ispismp_modified.png" style = "max-width:100%; height:auto;"><br/><br/>\
# 배경 <br/>\
...
//IT-ROI
'# 정의 : ? <br/>\
IT-ROI 체계는 IT 프로젝트에 대한 사전, 중간, 사후평가를 수행하며각 단계의 평가결과는 다음 단계의 평가에 피드백<br/>\
* 128회 관리 1교시 1\
',
