...
'<re>Grouping Keyword</re></re>',
'<re>MECE</re>',
'<re>[Standard]- 국제 표준화 기구</re>',
'<re>[Standard]- de facto standard</re>',
'<re><font color="blue" size=4 face="impact">ITSM</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM]- SoW/SLA/SLM</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM]- SLA</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM][SLA]- Penalty/Incentive</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM][SLA]- SIP</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM][SLA]- Annual Reset</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM]- OLA</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM]- SLM</font></re>',
'<re>아웃소싱 운영관리 메뉴얼</re>',
'<re><font color="blue" size=4 face="impact">[ITSM]- 장애 관리</font></re>',
'<re><font color="blue" size=4 face="impact">[ITSM]- 문제 관리</font></re>',
'<re>ISO 31000</re>',
'<re><font color="blue" size=4 face="impact">ITIL</font></re>',
'<re>[ITIL]- SKMS</re>',
'<re>[정보화 사업]- Enterprise Arcitecture</re>',
'<re>[정보화 사업]- Information Strategy Plan</re>',
'<re>[정보화 사업]- Information Strategy Master Plan</re>',
'<re>[정보화 사업][Information Strategy Master Plan]- 정보시스템 구축사업 이행방안 수립절차</re>',
'<re>[정보화 사업][Information Strategy Master Plan]- 비용산정</re>',
'<re>플랫폼 경제</re>',
'<re>프로토콜 경제</re>',
'<re>데이터 경제</re>',
'<re>공유 경제</re>',
...
'<re>Chasm</re>',
'<re>하이테크 마케팅</re>',
'<re> 디지털 변혁 (Digital Transformation)</re>',
'<re>[경영환경분석]- Horizon Scanning(이슈탐지)</re>',
'<re>[경영환경분석]- Backcasting</re>',
'<re>BABOK</re>',
'<re>[성과관리 방법]- BSC</re>',
'<re>[성과관리 방법]- BSC 전략맵</re>',
'<re>[성과관리 방법]- <font color="blue" size=4 face="impact">IT-BSC</font></re>',
'<re><font color="blue" size=4 face="impact">ESG 경영</font></re>',
'<re>[성과관리 방법]- MBO</re>',
'<re>[성과관리 방법]- OKR</re>',
'<re>코호트분석(Cohort Analysis)</re>',
'<re>악마의 강</re>',
'<re>죽음의 계곡(Death Valley)</re>',
'<re>다윈의 바다</re>',
'<re>퍼펙트 스톰</re>',
'<re>그로스 해킹</re>',
'<re>라이프(Life) 해킹</re>',
'<re>시빅(Civic) 해킹</re>',
'<re>메이커 운동(Maker Movement)</re>',
'<re>메이커 스페이스(Maker Space)</re>',
'<re>[Governance]- 인터넷 거버넌스</re>',
'<re>[Governance]- 데이터 분석 거버넌스</re>',
'<re>ISO 26000</re>',
'<re>[ISO 26000]- CSR</re>',
'<re><font color="blue" size=4 face="impact">BCP</font></re>',
'<re><font color="blue" size=4 face="impact">[BCP]- RTO, RPO</font></re>',
'<re><font color="blue" size=4 face="impact">[BCP]- BIA</font></re>',
'<re><font color="blue" size=4 face="impact">[BCP]- ISO 22301</font></re>',
'<re><font color="blue" size=4 face="impact">[BCP]- DRS</font></re>',
'<re><font color="blue" size=4 face="impact">[BDP]- DRP</font></re>',
'<re><font color="blue" size=4 face="impact">[BCP]- BPR</font></re>',
'<re><font color="blue" size=4 face="impact">[BCP]- PI</font></re>',
'<re><font color="blue" size=4 face="impact">TOC</font></re>',
'<re><font color="blue" size=4 face="impact">[환경분석]- 5 Force</font></re>',
'<re><font color="blue" size=4 face="impact">[환경분석]- 7S</font></re>',
'<re>빅블러 현상</re>',
'<re>옴니채널(Omni-Channel)</re>',
'<re>[옴니채널]- 쇼루밍</re>',
'<re>[옴니채널]- 역쇼루밍(Reverse Showrooming, 리버스 쇼루밍)</re>',
'<re>[옴니채널]- 모루밍</re>',
'<re>오프쇼어링(off shoring)</re>',
'<re>리쇼어링(Reshoring)</re>',
'<re>SCM</re>',
'<re>[SCM]- 채찍효과</re>',
'<re>[SCM]- CPFR</re>',
'<re>[공공 소프트웨어 사업 제안 요청서 작성 가이드라인]- 제안서</re>',
'<re>[공공 소프트웨어 사업 제안 요청서 작성 가이드라인]- 제안서 평가</re>',
'<re>[공공 소프트웨어 사업 제안 요청서 작성 가이드라인]- 공급자 선정</re>',
'<re>공공SW사업 대기업 참여제한 제도</re>',
'<re><font color="blue" size=4 face="impact">소프트웨어 영향평가 제도</font></re>',
'<re>넛지(Nudge) 이론</re>',
'<re>Philip Crosby의 품질경영 성숙도 모델 5단계</re>',
'<re>KANO Model</re>',
'<re>마세라티 문제(Maserati Problem)</re>',
'<re><font color="blue" size=4 face="impact">[IT-BS]- IT 투자</font></re>',
'<re><font color="blue" size=4 face="impact">[IT-BS]- IT 투자 성과 평가</font></re>',
'<re><font color="blue" size=4 face="impact">[IT-BS]- IT 투자 평가 항목</font></re>',
'<re>나라장터 </re>',
'<re>COBIT 5.0</re>',
'<re>IT-Compliance</re>',
'<re>규제 샌드박스</re>',
'<re>매매 임치제도</re>',
'<re>Design Thinking</re>',
'<re>Servitization</re>',
'<re>대기행렬이론</re>',
'<re>[대기행렬]- 대기행렬 시스템</re>',
'<re>Value Chain</re>',
'<re>MVP</re>',
'<re><font color="blue" size=4 face="impact">IT 거버넌스 프레임워크(IT Governance Framework)</font></re>',
);
