...
'<span>Grouping Keyword</span></span>',
'<span>MECE</span>',
'<span>[Standard]- 국제 표준화 기구</span>',
'<span>[Standard]- de facto standard</span>',
'<span><font color="blue" size=4 face="impact">ITSM</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM]- SoW/SLA/SLM</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM]- SLA</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM][SLA]- Penalty/Incentive</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM][SLA]- SIP</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM][SLA]- Annual Reset</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM]- OLA</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM]- SLM</font></span>',
'<span>아웃소싱 운영관리 메뉴얼</span>',
'<span><font color="blue" size=4 face="impact">[ITSM]- 장애 관리</font></span>',
'<span><font color="blue" size=4 face="impact">[ITSM]- 문제 관리</font></span>',
'<span>ISO 31000</span>',
'<span><font color="blue" size=4 face="impact">ITIL</font></span>',
'<span>[ITIL]- SKMS</span>',
'<span>[정보화 사업]- Enterprise Arcitecture</span>',
'<span>[정보화 사업]- Information Strategy Plan</span>',
'<span>[정보화 사업]- Information Strategy Master Plan</span>',
'<span>[정보화 사업][Information Strategy Master Plan]- 정보시스템 구축사업 이행방안 수립절차</span>',
'<span>[정보화 사업][Information Strategy Master Plan]- 비용산정</span>',
'<span>플랫폼 경제</span>',
'<span>프로토콜 경제</span>',
'<span>데이터 경제</span>',
'<span>공유 경제</span>',
...
'<span>가상융합 경제</span>',
'<span>RTE</span>',
'<span>[RTE]- 사이클론모델</span>',
'<span>기술수명주기</span>',
'<span>Chasm</span>',
'<span>하이테크 마케팅</span>',
'<span> 디지털 변혁 (Digital Transformation)</span>',
'<span>[경영환경분석]- Horizon Scanning(이슈탐지)</span>',
'<span>[경영환경분석]- Backcasting</span>',
'<span>BABOK</span>',
'<span>[성과관리 방법]- BSC</span>',
'<span>[성과관리 방법]- BSC 전략맵</span>',
'<span>[성과관리 방법]- <font color="blue" size=4 face="impact">IT-BSC</font></span>',
'<span><font color="blue" size=4 face="impact">ESG 경영</font></span>',
'<span>[성과관리 방법]- MBO</span>',
'<span>[성과관리 방법]- OKR</span>',
'<span>코호트분석(Cohort Analysis)</span>',
'<span>악마의 강</span>',
'<span>죽음의 계곡(Death Valley)</span>',
'<span>다윈의 바다</span>',
'<span>퍼펙트 스톰</span>',
'<span>그로스 해킹</span>',
'<span>라이프(Life) 해킹</span>',
'<span>시빅(Civic) 해킹</span>',
'<span>메이커 운동(Maker Movement)</span>',
'<span>메이커 스페이스(Maker Space)</span>',
'<span>[Governance]- 인터넷 거버넌스</span>',
'<span>[Governance]- 데이터 분석 거버넌스</span>',
'<span>ISO 26000</span>',
'<span>[ISO 26000]- CSR</span>',
'<span><font color="blue" size=4 face="impact">BCP</font></span>',
'<span><font color="blue" size=4 face="impact">[BCP]- RTO, RPO</font></span>',
'<span><font color="blue" size=4 face="impact">[BCP]- BIA</font></span>',
'<span><font color="blue" size=4 face="impact">[BCP]- ISO 22301</font></span>',
'<span><font color="blue" size=4 face="impact">[BCP]- DRS</font></span>',
'<span><font color="blue" size=4 face="impact">[BDP]- DRP</font></span>',
'<span><font color="blue" size=4 face="impact">[BCP]- BPR</font></span>',
'<span><font color="blue" size=4 face="impact">[BCP]- PI</font></span>',
'<span><font color="blue" size=4 face="impact">TOC</font></span>',
'<span><font color="blue" size=4 face="impact">[환경분석]- 5 Force</font></span>',
'<span><font color="blue" size=4 face="impact">[환경분석]- 7S</font></span>',
'<span>빅블러 현상</span>',
'<span>옴니채널(Omni-Channel)</span>',
'<span>[옴니채널]- 쇼루밍</span>',
'<span>[옴니채널]- 역쇼루밍(Reverse Showrooming, 리버스 쇼루밍)</span>',
'<span>[옴니채널]- 모루밍</span>',
'<span>오프쇼어링(off shoring)</span>',
'<span>리쇼어링(Reshoring)</span>',
'<span>SCM</span>',
'<span>[SCM]- 채찍효과</span>',
'<span>[SCM]- CPFR</span>',
'<span>[공공 소프트웨어 사업 제안 요청서 작성 가이드라인]- 제안서</span>',
'<span>[공공 소프트웨어 사업 제안 요청서 작성 가이드라인]- 제안서 평가</span>',
'<span>[공공 소프트웨어 사업 제안 요청서 작성 가이드라인]- 공급자 선정</span>',
'<span>공공SW사업 대기업 참여제한 제도</span>',
'<span><font color="blue" size=4 face="impact">소프트웨어 영향평가 제도</font></span>',
'<span>넛지(Nudge) 이론</span>',
'<span>Philip Crosby의 품질경영 성숙도 모델 5단계</span>',
'<span>KANO Model</span>',
'<span>마세라티 문제(Maserati Problem)</span>',
'<span><font color="blue" size=4 face="impact">[IT-BS]- IT 투자</font></span>',
'<span><font color="blue" size=4 face="impact">[IT-BS]- IT 투자 성과 평가</font></span>',
'<span><font color="blue" size=4 face="impact">[IT-BS]- IT 투자 평가 항목</font></span>',
'<span>나라장터 </span>',
'<span>COBIT 5.0</span>',
...
'<span>대기행렬이론</span>',
'<span>[대기행렬]- 대기행렬 시스템</span>',
'<span>Value Chain</span>',
'<span>MVP</span>',
'<span><font color="blue" size=4 face="impact">IT 거버넌스 프레임워크(IT Governance Framework)</font></span>',
);
